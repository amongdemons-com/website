...
const SAMSUNG_INTERNET_PATTERN = /\bSamsungBrowser\//i;
const GAME_PATH_PATTERN = /^\/(?:camp|world|dungeon|bag|collection|skill-tree)(?:\/|$)/i;
const LEGACY_GAME_PATH_PATTERN = /^\/app\/(?:camp|world|dungeon|bag|collection|skill-tree)\.html$/i;
...
function isSamsungInternet(navigatorLike = {}) {
  return SAMSUNG_INTERNET_PATTERN.test(String(navigatorLike.userAgent || ''));
}
