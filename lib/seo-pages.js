...
function renderEventsPage() {
  ...
  const description = 'Every Among Demons world event, from forsaken shrines, darkness portals, and the Whispering Well to the traveling merchant, demon hunts, ambushes, PvP duels, and roaming world bosses - shown on the real world map.';
