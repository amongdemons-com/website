    ...
    main: `
      <section class="seo-boss-priority" style="--rarity-color: ${escapeHtml(getRarityColor(keyDemon?.rarity || 'mythic'))}">
        <header class="seo-boss-priority-heading">
          <div class="seo-boss-summary-art">
...
<html lang="en" data-bs-theme="dark">
  <head>
    ...
    <link href="/app/css/base.css?v=20260713-boss-guides-v1" rel="stylesheet">
  ...
  <body class="${escapeHtml(bodyClass)}">
    ...
    <script src="/app/js/session.js?v=20260709-guest-mode-v1"></script>
    <script src="/app/js/navigation.js?v=20260713-boss-guides-v1"></script>
  </body>
</html>
`;
}
...
function renderBossCard(boss) {
  ...
  return `
    <article class="seo-demon-card seo-boss-card" style="--rarity-color: ${escapeHtml(getRarityColor(rarity))}">
      <a class="seo-demon-card-art" href="${getBossPagePath(boss)}" aria-label="${escapeHtml(title)} world boss guide">
