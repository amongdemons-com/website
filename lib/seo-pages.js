...
<html lang="en" data-bs-theme="dark">
  ...
  <body class="${escapeHtml(bodyClass)}">
    ...
    <script src="/app/js/navigation.js?v=20260713-global-shortcuts-v2"></script>
  </body>
</html>
`;
}
      ...
      <div class="container">
        <div class="site-footer-main">
          ...
          <div class="site-footer-community">
            ...
            <a class="site-footer-github" href="https://github.com/amongdemons-com" target="_blank" rel="noopener noreferrer" aria-label="Visit Among Demons on GitHub (opens in a new tab)">
        ...
        <div class="site-footer-bottom">
          ...
          <nav class="footer-links" aria-label="Footer links">
            ...
            <a href="https://github.com/amongdemons-com" target="_blank" rel="noopener noreferrer">GitHub</a>
          </nav>
        </div>
      </div>
    </footer>
