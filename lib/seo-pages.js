...
<html lang="en" data-bs-theme="dark">
  <head>
    ...
    <link href="/app/css/base.css?v=20260709-guest-mode-v2" rel="stylesheet">
  </head>
  <body class="${escapeHtml(bodyClass)}">
    ...
    <script src="/app/js/lucide-subset.js?v=20260709-guest-mode-v1"></script>
    ...
    <script src="/app/js/navigation.js?v=20260711-brand-camp-v1"></script>
  </body>
</html>
`;
}
