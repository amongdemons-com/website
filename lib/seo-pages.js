...
const DEFAULT_IMAGE_PATH = '/app/images/assets/background/amongdemons_home.png?v=art-3668d0ffc131';
const DEFAULT_IMAGE_PATH_LOGO = '/app/images/assets/background/amongdemons_home_logo.png?v=art-3668d0ffc131';
const DUNGEON_IMAGE_PATH = '/app/images/assets/background/amongdemons_dungeon.png?v=art-3668d0ffc131';
const DEMONS_IMAGE_PATH = '/app/images/demons/1.png?v=art-3668d0ffc131';
...
function getDemonImagePath(demon) {
  return `/app/images/demons/${getDemonSlug(demon)}.png?v=art-3668d0ffc131`;
}
    ...
    main: `
      ...
      <section class="seo-section">
        ...
        <div class="seo-media-grid">
          ...
          ${renderPressAsset('/app/images/assets/background/amongdemons_collection.png?v=art-3668d0ffc131', 'Collection artwork', '1600 × 900 PNG')}
        </div>
        <div class="seo-action-row">
...
function renderSitemap(catalog, bossCatalog = []) {
  ...
  const entries = [
    ...
    },
    {
      ...
      priority: '0.85',
      changefreq: 'weekly',
      images: [imageEntry('/app/images/assets/background/amongdemons_collection.png?v=art-3668d0ffc131', 'Among Demons demon collection checklist artwork')]
    },
    {
    ...
    },
    {
      ...
      priority: '0.5',
      changefreq: 'daily',
      images: [imageEntry('/app/images/assets/background/amongdemons_rankings.png?v=art-3668d0ffc131', 'Among Demons dungeon rankings artwork')]
    },
    {
        ...
        <div class="collapse navbar-collapse" id="publicGameNav">
          ...
          <div class="nav-account d-none" data-nav-account>
            ...
            <a class="nav-player" href="/camp" title="Go to camp">
              <span class="nav-player-avatar" aria-hidden="true"><img src="/app/images/demons/map/1.webp?v=art-3668d0ffc131" alt="" width="34" height="34" loading="eager" data-nav-profile-image></span>
