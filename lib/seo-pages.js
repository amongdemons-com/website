      ...
      <section class="seo-hero seo-home-hero">
        <div class="seo-hero-copy">
          ...
          <div class="seo-action-row">
            ...
            <a class="btn btn-glass-muted btn-lg" href="/demons">Browse Demons</a>
          </div>
...
const WORLD_EVENTS_GUIDE = [
  ...
  },
  {
    ...
    chips: ['Stays 30 min', 'Up to 4 offers', 'Bribe 50 to reroll']
  },
  {
    icon: 'crosshair',
    accent: '#9365B8',
  ...
  },
  {
    ...
    imageAlt: 'A roaming world boss marker on the Among Demons world map',
  ...
  },
  {
    ...
    imageAlt: 'The dark off-road wilderness where ambushes strike in Among Demons',
...
function renderEventsPage() {
  ...
  const description = 'Every Among Demons world event, from forsaken shrines and darkness portals to the traveling merchant, demon hunts, ambushes, PvP duels, and roaming world bosses — shown on the real world map.';
    ...
    main: `
      <section class="seo-hero seo-events-hero">
        <div class="seo-hero-copy">
          ...
          <h1>World Events</h1>
          <p>Everything that can happen while you roam the wilds of Among Demons — and exactly how each one looks on the world map.</p>
        </div>
      </section>
