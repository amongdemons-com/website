...
const WORLD_EVENTS_GUIDE = [
  ...
  },
  {
    ...
    blurb: 'Offer Souls at this fixed altar to summon The Anomaly, which channels all eleven demon types and always retaliates with Thorns.',
    chips: ['Area 4, 0', '10k Souls', '25% Mythic Echo']
  },
  {
    icon: 'amphora',
    accent: '#d7b765',
