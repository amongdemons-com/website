...
import * as lifecycle from './dungeon/lifecycle.js?v=20260715-grim-defeat-v1';
import * as render from './dungeon/render.js?v=20260716-primary-replay-controls-v1';
import * as combat from './dungeon/combat.js?v=20260715-fight-intro-controls-v1';
