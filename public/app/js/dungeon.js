...
import * as lifecycle from './dungeon/lifecycle.js?v=20260716-replay-only-controls-v1';
import * as render from './dungeon/render.js?v=20260716-replay-only-controls-v2';
import * as combat from './dungeon/combat.js?v=20260716-replay-only-controls-v1';
