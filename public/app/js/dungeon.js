...
import * as lifecycle from './dungeon/lifecycle.js?v=20260722-request-optimization-v1';
import * as render from './dungeon/render.js?v=20260912-group-rarity-enemy-buffs-v1';
...
import * as recruit from './dungeon/recruit.js?v=20260912-echo-complete-tag-v1';
