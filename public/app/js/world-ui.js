...
(function() {
  ...
  const DEFAULT_PROFILE_IMAGE_URL = '/app/images/demons/map/1.webp?v=art-102485fdb26d';
    ...
    return `
      <article class="world-sidebar-card world-merchant-card">
        <span class="world-merchant-card-portrait" aria-hidden="true">
          <img src="/app/images/assets/world/crowley.webp?v=art-102485fdb26d" alt="" width="512" height="512" loading="lazy" decoding="async">
        </span>
  ...
  function renderCurrentSoulFont(soulFont) {
    return `
      <article class="world-sidebar-card world-merchant-card world-soul-font-card">
        <span class="world-merchant-card-portrait" aria-hidden="true">
          <img src="/app/images/assets/world/soul-font.webp?v=art-102485fdb26d" alt="" width="768" height="768" loading="lazy" decoding="async">
        </span>
        <span class="world-card-copy">
    ...
    demonMapAtlasPromise = (async () => {
      ...
      try {
        ...
        DEMON_MAP_ATLAS_IDS.forEach((id, index) => {
          ...
          textures.set(
            `/app/images/demons/map/${id}.webp?v=art-102485fdb26d`,
