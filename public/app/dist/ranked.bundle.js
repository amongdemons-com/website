...
${e}`:e}function Ye(e){let t=new Map;return e.querySelectorAll(".dungeon-demon-card[data-instance-id] .dungeon-demon-card-image img").forEach(n=>{let a=Yn(n);a&&!t.has(a)&&t.set(a,n)}),t}function $e(e,t){e.querySelectorAll(".dungeon-demon-card[data-instance-id] .dungeon-demon-card-image img").forEach(n=>{let a=Yn(n),r=a?t.get(a):null;r&&(_t(r,n),n.replaceWith(r),t.delete(a))})}function Yn(e){let n=e.closest(".dungeon-demon-card[data-instance-id]")?.dataset.instanceId,a=e.getAttribute("src")||"";return n&&a?`${n}|${a}`:""}function _t(e,t){Array.from(e.attributes).forEach(n=>{t.hasAttribute(n.name)||e.removeAttribute(n.name)}),Array.from(t.attributes).forEach(n=>{e.getAttribute(n.name)!==n.value&&e.setAttribute(n.name,n.value)})}function Be(e){e&&(e.disabled=!1)}function Ht(e){return e?e.charAt(0).toUpperCase()+e.slice(1):""}function y(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function jn(e){return window.CSS?.escape?window.CSS.escape(String(e)):String(e).replace(/["\\]/g,"\\$&")}function Ot(e){return(e||[]).map(t=>({...t}))}var Ee=window.AmongDemons.audio,qr="amongdemons:battle-intro-complete";var Ut=(...e)=>h.getDemonPosition(...e),Yr=(...e)=>h.renderDemonStatus(...e),jr=(...e)=>h.renderDungeonCenterActions(...e),zt=(...e)=>h.renderFightLog(...e),Ae=(...e)=>h.renderFightLogActions(...e),We=(...e)=>h.renderRun(...e);function Un(e={}){if(!s.run)return null;let t=Xe(s.combatLog,{combineCounters:!0}),n={currentIndex:0,isPaused:!1,stepDirection:0,steps:t,totalSteps:t.length,waitResolve:null};return s.combatPlayback=n,s.isBattleAnimating=!0,e.render!==!1&&(We(),zt()),n}async function mt(e={}){if(!s.run)return;let t=e.combatPlayback,n=t&&s.combatPlayback===t?t:Un({render:!1});if(!n)return;let a=n.steps||[];if(s.isBattleAnimating=!0,We(),zt(),e.waitForBattleIntro){if(jr({canFight:!0,isFighting:!0}),await Ee?.play("sfx.battle.battleStart",{volume:.9,waitForEnd:!0}),!s.run||s.combatPlayback!==n)return;window.dispatchEvent(new CustomEvent(qr))}We(),zt();try{for(;s.combatPlayback&&s.combatPlayback.currentIndex<a.length;){let r=await Qr();if(!r||!s.combatPlayback)break;if(r==="previous"){await to();continue}let o=s.combatPlayback.currentIndex,i=a[o];if(!i)break;Z(!1),Kt(i,o,{animate:!0}),s.combatPlayback.currentIndex=o+1,Ae(),await Zn(q(rn(i))),Z(!!s.combatPlayback?.isPaused)}}finally{s.isBattleAnimating=!1,s.combatPlayback=null,Z(!1),We()}ft(-1)}function Kt(e,t=-1,n={}){let a=ao(),r=n.animate!==!1;if(e.entries.forEach(u=>{let f=a.get(u.target);f&&(f.hp=u.targetHp,u.effect==="poison_apply"&&(f.statusEffects=f.statusEffects||{},f.statusEffects.poison=Array.from({length:Math.max(1,Number(u.poisonStacks)||1)},()=>({}))),u.effect==="poison"&&Object.prototype.hasOwnProperty.call(u,"poisonStacks")&&(f.statusEffects=f.statusEffects||{},f.statusEffects.poison=Array.from({length:Math.max(0,Number(u.poisonStacks)||0)},()=>({}))))}),Qn(),!r){ea();return}ft(t);let o=oe(e.attacker),i=gt(e),c=new Map(i.map((u,f)=>[u,f])),d=!!e.isAoe||i.length>1;Wr(e),e.primaryEffect!=="poison"&&ta(e.attacker,e.primaryEffect,e.entries[0]?.target);let l=Kr(e);l&&ua(e.attacker,l.targetIds,{effect:e.primaryEffect,travel:l.travel});let g=Xr(e);g&&tn(e.attacker,g.targetId),e.entries.forEach(u=>{let f=c.get(u)??0;Kn(u,e,o,f,d,l,g)})}function Wr(e){let t=e.entries?.[0]||{},n=e.primaryEffect||t.effect;if(n==="poison"||n==="heal"||n==="last_breath"||n==="shared_pain")return;let a=null;if(n==="poison_apply")a="sfx.battle.abilities.poisonApply";else if(n==="retaliate"||n==="thorns")a="sfx.battle.abilities.thornsRetaliate";else{let r=Number(Q(e.attacker)?.typeId);a={1:"sfx.battle.abilities.meleeSwing",2:"sfx.battle.abilities.rangedProjectile",3:"sfx.battle.abilities.poisonApply",4:"sfx.battle.abilities.fireAoe",5:"sfx.battle.abilities.bruiserStrike",6:"sfx.battle.abilities.assassinStrike",7:"sfx.battle.abilities.cleave",8:"sfx.battle.abilities.thornsRetaliate",9:"sfx.battle.abilities.juggernautSlam",10:"sfx.battle.abilities.heal",11:"sfx.battle.abilities.chaosAttack"}[r]||"sfx.battle.abilities.meleeSwing"}Ee?.play(a,{volume:.72,minInterval:55}),!J(t)&&(e.entries||[]).some(J)&&Ee?.play("sfx.battle.abilities.thornsRetaliate",{volume:.66,minInterval:55})}var Ur=new Set(["poison","heal","last_breath","shared_pain","poison_apply"]);function J(e){return e?.effect==="retaliate"||e?.effect==="thorns"}function gt(e){return(e.entries||[]).filter(t=>!J(t))}function ut(e){return!J(e)&&!Ur.has(e.effect)}function Kr(e){if(z()||e.targeting==="chaotic"||Number(Q(e.attacker)?.typeId)!==4)return null;let t=(e.entries||[]).filter(ut);return t.length?{targetIds:t.map(n=>n.target),travel:Ue(t[0]).travel,lead:90}:null}function Xr(e){if(z()||Number(Q(e.attacker)?.typeId)!==7)return null;let t=(e.entries||[]).filter(ut);return t.length?{targetId:t[Math.floor((t.length-1)/2)].target}:null}function Kn(e,t,n,a,r,o=null,i=null){let c=z();if(e.effect==="poison"){Se(160,()=>{a===0&&Ee?.play("sfx.battle.abilities.poisonTick",{volume:.66,minInterval:80}),a===0&&je(e.target,ln(t),"poison",e.attacker,e.effect,{burstCount:t.entries.length}),pe(e.target,e.targetHp,n,{hit:!1}),Yt(e.target,e.poisonStacks),Vt(e.target)});return}if(e.effect==="heal"){c||ga(e.attacker,e.target),Se(200,()=>{Ee?.play("sfx.battle.abilities.heal",{volume:.7,minInterval:80}),pe(e.target,e.targetHp,n,{hit:!1,healing:e.healing}),je(e.target,e.healing,"heal",e.attacker,e.effect),qt(e.target)});return}if(e.effect==="last_breath"){Se(160,()=>{pe(e.target,e.targetHp,n,{hit:!1}),je(e.target,1,"heal",e.attacker,e.effect),qt(e.target)});return}if(e.effect==="shared_pain"){pe(e.target,e.targetHp,n,{hit:!1});return}if(e.effect==="poison_apply"){c||Le(t.attacker,e.target,{effect:e.effect,poison:!0,bubbles:15,variant:"poison-flame"}),Se(220,()=>{Yt(e.target,e.poisonStacks||1),pe(e.target,e.targetHp,n),Gt(e.target,{attackerId:e.attacker,effect:e.effect,variant:"poison"}),Vt(e.target)});return}let d=Ue(e),l=o&&ut(e),g=i&&ut(e),u=l||g,f=!J(e)||Zr(e,t);!c&&!u&&f&&d.draw();let x=l?o.travel+o.lead+a*50:d.travel+(r?a*70:0);Se(x,()=>{pe(e.target,e.targetHp,n);let v=Xn(e,t);v>0&&je(e.target,v,ha(e.attacker)?"dark":"damage",e.attacker,e.effect),Gt(e.target,{attackerId:e.attacker,effect:e.effect,heavy:d.heavy,variant:d.key,aoe:r&&!J(e)}),sa(e.target,d.heavy),d.screenShake&&ca(),la(e.target,e.targetHp)})}function Xn(e,t){let n=Math.max(0,Number(e?.dmg)||0);if(!J(e))return n;let a=(t?.entries||[]).filter(r=>J(r)&&r.target===e.target);return a[0]!==e?0:a.reduce((r,o)=>r+Math.max(0,Number(o.dmg)||0),0)}function Zr(e,t){if(!J(e))return!0;let n=(t?.entries||[]).filter(J),a=n.filter(o=>o.effect==="retaliate"||Jr(o.attacker));return(a.length?a:n).find(o=>o.attacker===e.attacker)===e}function Jr(e){let t=Q(e)||{},n=String(t.role||"").toLowerCase(),a=String(t.abilityKind||t.ability_kind||t.ability?.kind||"").toLowerCase();return Number(t.typeId)===8||n==="counter_tank"||a==="retaliate"}async function Qr(){for(;s.combatPlayback?.isPaused;){Z(!0);let e=Number(s.combatPlayback.stepDirection)||0;if(s.combatPlayback.stepDirection=0,e<0)return"previous";if(e>0)return s.combatPlayback.currentIndex<s.combatPlayback.totalSteps?"next":null;await eo()}return Z(!1),s.combatPlayback?"play":null}function Zn(e){let t=s.combatPlayback;return t?new Promise(n=>{let a=window.setTimeout(r,Math.max(0,Number(e)||0));function r(){window.clearTimeout(a),t.waitResolve===r&&(t.waitResolve=null),n()}t.waitResolve=r}):Promise.resolve()}function eo(){let e=s.combatPlayback;return e?new Promise(t=>{e.waitResolve=()=>{e.waitResolve=null,t()}}):Promise.resolve()}function Xt(){!s.combatPlayback||!s.isBattleAnimating||(s.combatPlayback.isPaused=!0,Z(!0),pt(),Ae())}function Zt(){!s.combatPlayback||!s.isBattleAnimating||(s.combatPlayback.isPaused=!1,s.combatPlayback.stepDirection=0,Z(!1),pt(),Ae())}function Jt(e){!s.combatPlayback||!s.isBattleAnimating||(s.combatPlayback.isPaused=!0,s.combatPlayback.stepDirection=Number(e)<0?-1:1,Z(!0),pt(),Ae())}function Qt(){let e=s.combatPlayback;!s.run||!e||!s.isBattleAnimating||(e.isPaused=!1,e.stepDirection=0,Jn(e.totalSteps),Z(!1),pt())}function pt(){let e=s.combatPlayback?.waitResolve;e&&e()}function Jn(e){if(!s.run||!s.combatPlayback)return;ro(),no();let t=s.combatPlayback.steps||[],n=en(Math.floor(Number(e)||0),0,t.length);for(let a=0;a<n;a+=1)Kt(t[a],a,{animate:!1});s.combatPlayback.currentIndex=n,We(),ft(n>0?n-1:-1)}async function to(){let e=s.combatPlayback;if(!s.run||!e||e.currentIndex<=0)return;let t=e.steps||[],n=en(e.currentIndex-2,0,t.length-1),a=t[n];a&&(Jn(n),Z(!1),Kt(a,n,{animate:!0}),e.currentIndex=n+1,Ae(),await Zn(q(rn(a))),s.combatPlayback&&(s.combatPlayback.isPaused=!0,Z(!0),Ae()))}function no(){let e=s.run?.lastBattle||{};s.run.team=Ot(e.playerTeamBefore||s.run.team||[]),s.run.enemies=Ot(e.enemyTeamBefore||s.run.enemies||[]),s.combatDemons=Ze()}function ao(){return new Map([...s.run?.team||[],...s.run?.enemies||[]].map(e=>[e.instanceId,e]))}function ro(){uo(),document.querySelectorAll([".attack-zap",".chaos-lightning",".combat-impact-burst",".dark-spike",".fireball-shot",".fire-nova",".floating-combat-number",".heal-effect",".sword-swing",".thorn-burst"].join(",")).forEach(e=>e.remove()),document.querySelector(".dungeon-arena")?.classList.remove("is-combat-screenshake")}function Z(e){let t=!!e;document.documentElement.classList.toggle("is-combat-paused",t),t?co():lo()}function en(e,t,n){return Math.max(t,Math.min(n,Number(e)||0))}function Qn(){s.run&&(s.run.hp=(s.run.team||[]).reduce((e,t)=>e+Math.max(0,Number(t.hp)||0),0))}function ea(){[...s.run?.team||[],...s.run?.enemies||[]].forEach(e=>{pe(e.instanceId,e.hp)})}function ft(e){document.querySelectorAll(".fight-log-row").forEach(t=>{t.classList.toggle("active",Number(t.dataset.logIndex)===e)})}function ta(e,t,n){let a=A(e);a&&(an(a,nn(e,t)),a.classList.toggle("is-player-attack",oe(e)==="player"),a.classList.toggle("is-enemy-attack",oe(e)==="enemy"),oo(a,n),fe(a,"is-attacking",320))}function oo(e,t){if(z()||!t){e.style.setProperty("--lunge-x","0px"),e.style.setProperty("--lunge-y","0px");return}let n=A(t);if(!n){e.style.setProperty("--lunge-x","0px"),e.style.setProperty("--lunge-y","0px");return}let a=e.getBoundingClientRect(),r=n.getBoundingClientRect(),o=r.left+r.width/2-(a.left+a.width/2),i=r.top+r.height/2-(a.top+a.height/2),c=Math.hypot(o,i)||1,d=Math.min(18,c*.26);e.style.setProperty("--lunge-x",`${(o/c*d).toFixed(1)}px`),e.style.setProperty("--lunge-y",`${(i/c*d).toFixed(1)}px`)}function Ue(e){let{attacker:t,target:n,effect:a}=e;if(J(e))return{key:"thorn",travel:210,heavy:!1,screenShake:!1,draw:()=>jt(t,n)};if(e.targeting==="chaotic")return{key:"chaotic",travel:150,heavy:!0,screenShake:!1,draw:()=>pa(t,n)};let r=Number(Q(t)?.typeId);return{2:{key:"dark",travel:200,heavy:!1,draw:()=>fa(t,n)},4:{key:"fire",travel:380,heavy:!0,screenShake:!1,draw:()=>da(t,n,{effect:a})},5:{key:"sniper",travel:360,heavy:!0,draw:()=>Le(t,n,{effect:a,variant:"heavy",duration:520})},6:{key:"assassin",travel:120,heavy:!1,draw:()=>Le(t,n,{effect:a,variant:"assassin",duration:240})},7:{key:"melee",travel:170,heavy:!1,draw:()=>tn(t,n)},8:{key:"thorn",travel:210,heavy:!1,draw:()=>jt(t,n)},9:{key:"crushing",travel:620,heavy:!0,screenShake:!0,draw:()=>Le(t,n,{effect:a,variant:"crushing",duration:960})}}[r]||{key:"melee",travel:150,heavy:!1,draw:()=>Le(t,n,{effect:a})}}function io(e){Ue(e).draw()}function z(){return!!(window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches)}var De=new Set;function na(){return window.performance?.now?.()??Date.now()}function Se(e,t){let n=q(e);if(z()||n<=0){t();return}let a={fn:t,remaining:n,startedAt:0,handle:null};a.run=()=>{a.handle=null,De.delete(a),a.fn()},De.add(a),so()||aa(a)}function aa(e){e.startedAt=na(),e.handle=window.setTimeout(e.run,e.remaining)}function so(){return document.documentElement.classList.contains("is-combat-paused")}function co(){De.forEach(e=>{e.handle!=null&&(window.clearTimeout(e.handle),e.handle=null,e.remaining=Math.max(0,e.remaining-(na()-e.startedAt)))})}function lo(){De.forEach(e=>{e.handle==null&&aa(e)})}function uo(){De.forEach(e=>{e.handle!=null&&window.clearTimeout(e.handle)}),De.clear()}function Gt(e,t={}){if(z())return;let n=A(e);if(!n)return;let a=n.getBoundingClientRect(),r=Y(["combat-impact-burst",t.heavy?"is-heavy":"",t.aoe?"is-aoe":"",`is-${t.variant||"melee"}`].filter(Boolean).join(" "),t.attackerId,t.effect);r.style.left=`${(a.left+a.width/2).toFixed(1)}px`,r.style.top=`${(a.top+a.height/2).toFixed(1)}px`;let o=t.heavy?520:380;r.style.setProperty("--fx-duration",`${q(o)}ms`);let i=t.heavy?9:6,c=t.heavy?26:17,d=Array.from({length:i},(l,g)=>{let u=360/i*g+(g%2?14:-10),f=c+g%3*5;return`<span class="combat-impact-particle" style="--p-angle:${u.toFixed(0)}deg;--p-dist:${f}px;animation-delay:${q(g*6)}ms"></span>`}).join("");r.innerHTML=`<span class="combat-impact-core"></span>${t.aoe?'<span class="combat-impact-ring"></span>':""}${d}`,j(r,o)}function ra(e){try{return localStorage.getItem(e)!=="0"}catch{return!0}}function oa(){return ra(zn)}function ia(){return ra(On)}function sa(e,t){if(z())return;let n=A(e);if(!n)return;let a=oa();fe(n,t&&a?"is-shaking":"is-hit",t&&a?360:240)}function Vt(e){if(z())return;let t=A(e);t&&fe(t,"is-poison-tick",520)}function qt(e){if(z())return;let t=A(e);t&&fe(t,"is-healed",520)}var Wn=0;function ca(){if(z()||!ia())return;let e=window.performance?.now?.()??Date.now();if(e-Wn<140)return;Wn=e;let t=document.querySelector(".dungeon-arena");t&&fe(t,"is-combat-screenshake",360)}function la(e,t){if(Number(t)>0)return;let n=A(e);!n||n.classList.contains("is-dying")||(Ee?.playDeath(),!z()&&fe(n,"is-dying",620))}function Le(e,t,n={}){let a=A(e),r=A(t);if(!a||!r)return;let{attackerRect:o,startX:i,startY:c,endX:d,endY:l}=Ke(a,r),g=Q(e),u=g&&Ut(g)==="back",f=u?.12:.22,x=u?.9:.78,v=i+(d-i)*f,R=c+(l-c)*f,w=i+(d-i)*x,C=c+(l-c)*x,M=(v+w)/2,F=(R+C)/2,T=-(C-R)/Math.max(1,Math.hypot(w-v,C-R)),I=(w-v)/Math.max(1,Math.hypot(w-v,C-R)),X=u?10:6,ne=M+T*X,ae=F+I*X,ue=Number(n.bubbles)||0,Pe=ue?Array.from({length:ue},(ye,O)=>{let E=.08+O/Math.max(1,ue-1)*.84,ve=(1-E)*(1-E)*v+2*(1-E)*E*ne+E*E*w,Ft=(1-E)*(1-E)*R+2*(1-E)*E*ae+E*E*C,Ve=(O%2?-1:1)*(4+O%4),V=2.2+O%4*.8;return`<circle class="poison-bubble" cx="${(ve+T*Ve).toFixed(1)}" cy="${(Ft+I*Ve).toFixed(1)}" r="${V.toFixed(1)}" style="animation-delay: ${q(O*18).toFixed(0)}ms" />`}).join(""):"",H=Number(n.flames)||0,D=H?Array.from({length:H},(ye,O)=>{let E=.08+O/Math.max(1,H-1)*.84,ve=(1-E)*(1-E)*v+2*(1-E)*E*ne+E*E*w,Ft=(1-E)*(1-E)*R+2*(1-E)*E*ae+E*E*C,Ve=(O%2?-1:1)*(5+O%3*2),V=5+O%4,ke=ve+T*Ve,we=Ft+I*Ve;return`<path class="fire-spark" d="M ${ke.toFixed(1)} ${(we-V).toFixed(1)} C ${(ke+V*.72).toFixed(1)} ${(we-V*.2).toFixed(1)} ${(ke+V*.45).toFixed(1)} ${(we+V*.72).toFixed(1)} ${ke.toFixed(1)} ${(we+V).toFixed(1)} C ${(ke-V*.55).toFixed(1)} ${(we+V*.42).toFixed(1)} ${(ke-V*.45).toFixed(1)} ${(we-V*.32).toFixed(1)} ${ke.toFixed(1)} ${(we-V).toFixed(1)} Z" style="animation-delay: ${q(O*16).toFixed(0)}ms" />`}).join(""):"",me=Y(["attack-zap",oe(e)==="player"?"is-player-attack":"is-enemy-attack",u?"is-back-attack":"",n.variant?`is-${n.variant}`:"",n.poison?"is-poison-apply":""].filter(Boolean).join(" "),e,n.effect);me.innerHTML=ie(`
  ...
  `),j(ue,620);let Pe=Number(n.travel)||380;Se(Pe,()=>ma(l,g,X,e,n.effect))}function ma(e,t,n,a,r){if(z())return;let o=Math.max(20,Number(n)||60),i=Y("fire-nova",a,r),c=`fire-nova-grad-${Math.random().toString(36).slice(2,8)}`;i.innerHTML=ie(`
      <defs>
  ...
  `),j(f,520)}function mo(e){let t=A(e);t&&fe(t,"is-shaking",360)}function ga(e,t){let n=A(t);if(!n)return;let a=n.getBoundingClientRect(),r=a.left+a.width/2,o=a.top+a.height/2,i=Math.max(18,a.width*.18),c=Y("heal-effect",e,"heal");c.innerHTML=ie(`
  ...
  `}function So(e,t){return!!(t==="player"&&e.side==="player"&&s.isRecruiting&&s.run?.awaitingRecruit&&s.run?.collectionReinforcementAvailable&&(s.recruitDraftTeam||[]).length<fo()&&Pa().length<Ra())}function Ro(e){return!!(s.isRecruiting&&e.side==="hand"&&s.run?.collectionReinforcementAvailable&&Pa().length<Ra())}function Po(e){return`
...
`)}function Io(e={}){let t=Date.parse(e.expiresAt||"");if(!Number.isFinite(t))return"";let n=Math.ceil((t-Date.now())/1e3);return n<=0?"Expired":`Expires in ${No(n)}`}function No(e){let t=Math.max(0,Math.floor(Number(e)||0)),n=Math.floor(t/86400),a=Math.floor(t%86400/3600),r=Math.floor(t%3600/60);return n>0?`${n}d ${a}h`:a>0?`${a}h ${r}m`:r>0?`${r}m`:`${t}s`}function _o(e){return y(e).replace(/\n/g,"&#10;")}function Ma(){Ba||(Ba=!0,document.addEventListener("pointerover",e=>{let t=e.target.closest?.(".active-pact-chip");t&&vt(t)}),document.addEventListener("focusin",e=>{let t=e.target.closest?.(".active-pact-chip");t&&vt(t)}),document.addEventListener("click",e=>{let t=e.target.closest?.(".active-pact-chip");document.querySelectorAll(".active-pact-chip.is-tooltip-visible").forEach(n=>{n!==t&&n.classList.remove("is-tooltip-visible")}),t&&(vt(t),t.classList.add("is-tooltip-visible"))}),document.addEventListener("keydown",e=>{e.key==="Escape"&&document.querySelectorAll(".active-pact-chip.is-tooltip-visible").forEach(t=>{t.classList.remove("is-tooltip-visible")})}),window.addEventListener("resize",Ea),window.addEventListener("scroll",Ea,!0))}function Ea(){document.querySelectorAll(".active-pact-chip.is-tooltip-visible").forEach(vt)}function vt(e){if(!e)return;let t=e.getBoundingClientRect(),n=Math.min(384,window.innerWidth*.88),a=Ho(t.left+t.width/2,n/2+8,window.innerWidth-n/2-8),r=t.top>118,o=r?Math.max(8,t.top-8):Math.min(window.innerHeight-8,t.bottom+8);e.style.setProperty("--active-pact-tooltip-left",`${a}px`),e.style.setProperty("--active-pact-tooltip-top",`${o}px`),e.classList.toggle("is-tooltip-below",!r)}function Ho(e,t,n){return Math.max(t,Math.min(n,Number(e)||0))}var Oo=window.AmongDemons.audio,zo=window.AmongDemons.bagVisuals?.renderItemVisual||(()=>'<span class="bag-item-renderer bag-unknown-visual" aria-hidden="true"></span>');var Go=(...e)=>h.bindCollectionReinforcementPlaceholders(...e),Vo=(...e)=>h.bindDemonDetailCards(...e),qo=(...e)=>h.bindFormationDragAndDrop(...e),Yo=(...e)=>h.bindPointerDragAndDrop(...e),jo=(...e)=>h.bindRecruitDragAndDrop(...e),Wo=(...e)=>h.bindRewardDragAndDrop(...e),vn=(...e)=>h.canExtractRun(...e),Ta=(...e)=>h.formatBattleSpeed(...e),Uo=(...e)=>h.getRecruitPreviewEnemyTeam(...e),Ko=(...e)=>h.getRecruitPreviewHand(...e),Xo=(...e)=>h.getRecruitPreviewTeam(...e),Fa=(...e)=>h.applyDungeonCombatStatPreviewToDemon(...e),Zo=(...e)=>h.getRecruitTeamLimit(...e),Jo=(...e)=>h.groupCombatLog(...e),Wa=(...e)=>h.hasPendingBuffChoices(...e);var Qo=(...e)=>h.isExtractionUnlocked(...e),ei=(...e)=>h.isCurrentFloorBattle(...e),ti=(...e)=>h.pauseCombatPlayback(...e),ni=(...e)=>h.playEnemyRevealEffect(...e),ai=(...e)=>h.playPendingHandFlowAnimation(...e),ri=(...e)=>h.playRecruitSwapEffect(...e),Ua=(...e)=>h.renderButtonMeleeIcon(...e);var Ia=(...e)=>h.renderDemonCards(...e),oi=(...e)=>h.renderDungeonDemonCard(...e),ii=(...e)=>h.bindActivePactTooltips(...e),si=(...e)=>h.getActiveBuffs(...e),ci=(...e)=>h.createLevelPowerBuff(...e),hn=(...e)=>h.renderDemonicPacts(...e),li=(...e)=>h.toggleDemonicPactView(...e);var di=(...e)=>h.renderFightLogRow(...e),ui=(...e)=>h.renderHandBar(...e),mi=(...e)=>h.renderRewardBox(...e),kn=(...e)=>h.replayFight(...e),gi=(...e)=>h.requestRecruitContinue(...e),pi=(...e)=>h.resumeCombatPlayback(...e),fi=(...e)=>h.setBattleSpeed(...e),hi=(...e)=>h.skipCombatPlayback(...e),bi=(...e)=>h.startNewDungeonAfterDefeat(...e),Ka=(...e)=>h.startRun(...e),yi=(...e)=>h.stepCombatPlayback(...e);function wn(){let e=s.run,t=!!e;if(b.runLoading&&b.runLoading.classList.toggle("d-none",!s.isLoading),b.runEmpty.classList.toggle("d-none",s.isLoading||t),b.runPanel.classList.toggle("d-none",s.isLoading||!t),Ti(),Ai(),s.isLoading){ge&&ge.disconnect(),s.isMobileRewardBoxOpen=!1,b.dungeonBottomPanel?.classList.remove("is-battle-active","is-mobile-reward-open"),b.fightLog.innerHTML="Opening the latest dungeon state...",b.fightLog.classList.add("text-muted"),hn(!1),Qe(),Be();return}if(!e){ge&&ge.disconnect(),b.runPanel?.querySelector(".dungeon-arena")?.classList.remove("is-hand-strategy"),b.dungeonBottomPanel?.classList.add("d-none"),s.isMobileRewardBoxOpen=!1,b.dungeonBottomPanel?.classList.remove("is-battle-active","is-mobile-reward-open"),b.dungeonHandBar?.classList.add("d-none"),b.dungeonRewardBox?.classList.add("d-none"),hn(!1),_a(),Ha(),Oa(),b.runEmpty.innerHTML=s.endSummary?vi():ki(),wi(),Na(),Qe(),Be();return}let n=Wa(e),a=!!(s.isRecruiting&&e.awaitingRecruit),r=b.runPanel?.querySelector(".dungeon-arena"),o=(a?Xo():e.team||[]).map(Fa),i=a&&s.isEnemyPreviewDeferred?[]:a?Uo():e.enemies||[],c=!!e.replayOnly,d=!!(s.isBattleAnimating||c),l=!!(s.isPactTeamPreview&&n),g=!!(!a&&d),u=(a?Ko():[]).map(Fa),f=g?"battle":"recruit",x=!!(n&&!s.isPactRevealPending&&!s.isBattleAnimating&&!s.isResultAnimating),v=!!(n||s.isPactRevealPending),R=!0,w=!!(a&&!v),C=w,M=!!(!n&&!s.isResultAnimating&&vn()),F=za(b.teamGrid),T=za(b.enemyGrid),I=["player",e.awaitingRecruit?"recruit":"battle",s.isRecruiting?"interactive":"locked",n?"pacts":"ready"].join(":");b.dungeonBottomPanel?.classList.toggle("d-none",!R),(!M||s.isBattleAnimating||s.isResultAnimating)&&(s.isMobileRewardBoxOpen=!1),b.dungeonBottomPanel?.classList.toggle("is-battle-active",d||l),b.dungeonBottomPanel?.classList.toggle("is-mobile-reward-open",!!(s.isMobileRewardBoxOpen&&M&&!s.isBattleAnimating)),r?.classList.toggle("is-hand-strategy",a),te(b.teamGrid,Ia(o,{side:"player",allowFormationDrag:e.status==="active"&&!v&&(!e.awaitingRecruit||s.isRecruiting),gridStyle:F}),{patchFormationGrid:!0,renderKey:I}),te(b.enemyGrid,Ia(a||(e.team||[]).length?i:[],{side:"enemy",allowRecruitDrag:!1,gridStyle:T}),{patchFormationGrid:!0,renderKey:"enemy"}),ui(u,R,w,f),mi(R,C,M),hn(x),_a(a?o.length:null,a?Zo():null),Ha(a?e.nextEnemyPressure:e.enemyPressure,a?e.nextEnemyBuffs:e.enemyBuffs,a?e.nextEnemyTeamBuffs:e.enemyTeamBuffs),Oa(),qo(),jo(),Wo(),Yo(),Go(),Vo(),ii(),ri(),ni(),Di(),Na(),Qe(),Be(),ai(a)}function vi(){let e=s.endSummary||{};return e.outcome==="defeat"?Si(e):$i(e)}function ki(){return`
  ...
  `,document.body.appendChild(c),new Promise(d=>{setTimeout(()=>{c.remove(),s.isResultAnimating=!1,r&&(Qe(),Be()),d()},i)})}function _a(e=null,t=null){if(!b.teamSideTitle)return;let n=Number.isFinite(e)&&Number.isFinite(t)?`<span class="battle-side-count" aria-label="${e} of ${t} team slots used">${e}/${t}</span>`:"",a=Ri();b.teamSideTitle.innerHTML=`
    <span>Your Team</span>
    ${n?` ${n}`:""}
    ${et(a,{side:"player"})}
...
`),o=Ei(r),i=a?` style="--enemy-buff-color: ${y(It(e.rarity||"common"))}"`:"";return`
  ...
  `);return w&&(Ii(),Za()),w}function Ii(){N(document.getElementById("dungeonMobileHandBtn"),()=>ja("hand")),N(document.getElementById("dungeonMobileBuffsBtn"),()=>ja("pacts")),N(document.getElementById("dungeonMobileReplayBtn"),kn),N(document.getElementById("dungeonMobileLogBtn"),kt),N(document.getElementById("dungeonMobileExtractBtn"),Ni)}function ja(e){!s.run||s.isBattleAnimating||(s.activeHandTab=e==="pacts"?"pacts":"hand",wn())}function Ni(){s.isBattleAnimating||s.isResultAnimating||!vn()||(s.isMobileRewardBoxOpen=!s.isMobileRewardBoxOpen,wn())}function Sn(){let e=s.combatPlayback||{},t=!!e.isPaused,n=Number(e.currentIndex)||0,a=Number(e.totalSteps)||0,r=n>0,o=n<a;return`
  ...
  `}function Za(){[document.getElementById("dungeonFightBtn"),document.getElementById("dungeonMobileFightBtn")].forEach(e=>{!e||e.dataset.dungeonFightBound==="true"||(e.dataset.dungeonFightBound="true",N(e,t=>gi(t.currentTarget)))})}var Dt=window.AmongDemons.api,de=window.AmongDemons.audio,_i=window.AmongDemons.ui.renderDemonCard,Hi=window.AmongDemons.ui.renderCombatStats,L=window.AmongDemons.ui.renderIcon||(()=>""),nt=Object.freeze(["common","uncommon","rare","epic","legendary","mythic"]),Te=2,_e=20,Ja=Object.freeze({common:1,uncommon:2,rare:3,epic:4,legendary:5,mythic:7}),m={},Qa=new Set,G=!1,k=null,p=null,ce=!1,S=null,Rt=!1,An=0,K=0,Fe=null,wt=null,er=0,Dn=new Set,Mt=[],tr=null,at=0,$t=0,ot=null;Hn({...dn,battle:dr,getExplicitFormationRow:e=>le(e?.formationSlot),normalizeFormationRow:e=>le(e)??0,shouldShowCollectionMissingTag:()=>!1,getDemonPosition:Fs,renderDemonStatus:Is,renderDungeonCenterActions:Br,renderFightLog:br,renderFightLogActions:yr,renderRun:_});Hs(Oi);async function Oi(){if(!window.AmongDemons.getToken()){window.location.href=window.AmongDemons.appUrl("/login?next=/ranked");return}zi(),Gi(),Ma(),ht(),de?.setScene({music:"music.default"}),await Vi()}function zi(){["rankedMessage","runLoading","runEmpty","runPanel","rankedBottomPanel","rankedHandStatus","rankedPreparation","dungeonHandBar","dungeonBottomControls","dungeonReplayLogBox","teamSideTitle","enemySideTitle","teamGrid","enemyGrid","dungeonCenterActions","fightLog","demonicPactOverlay","demonicPactViewToggle","rankedPactGrid","rankedEndRunModal","rankedEndRunEyebrow","rankedEndRunSummary","rankedEndRunFloor","rankedEndRunGain","rankedEndRunRating","rankedVictoryModal","rankedVictoryRankImage","rankedVictoryDivision","rankedVictoryRankGain","rankedVictorySummary"].forEach(e=>{m[e]=document.getElementById(e)})}function Gi(){document.addEventListener("click",async e=>{if(e.target.closest("[data-ranked-end-confirm]")){e.preventDefault(),await Wi();return}let n=e.target.closest("[data-ranked-pact-scroll]");if(n){e.preventDefault(),rs(n);return}let a=e.target.closest("[data-ranked-victory-action]");if(a){e.preventDefault(),await bs(a.dataset.rankedVictoryAction);return}let r=e.target.closest("[data-battle-speed]");if(r){e.preventDefault(),on(Number(r.dataset.battleSpeed));return}let o=e.target.closest("[data-battle-step]");if(o){e.preventDefault(),Jt(Number(o.dataset.battleStep));return}if(e.target.closest("#battlePlaybackToggleBtn")){e.preventDefault(),s.combatPlayback?.isPaused?Zt():Xt();return}if(e.target.closest("#battlePlaybackSkipBtn")){e.preventDefault(),Qt();return}if(e.target.closest("#fightLogReplayBtn, #rankedMobileReplayBtn")){e.preventDefault(),e.target.closest(".ranked-mobile-review-menu")?.removeAttribute("open"),await Zi();return}if(e.target.closest("#fightLogToggleBtn, #rankedMobileLogBtn")){e.preventDefault(),e.target.closest(".ranked-mobile-review-menu")?.removeAttribute("open"),kt();return}if(e.target.closest("#demonicPactViewToggle, #demonicPactReturnBtn")){e.preventDefault(),ls();return}let i=e.target.closest("[data-ranked-action]");if(i?.matches("button")){e.preventDefault(),await nr(i,e);return}i&&(e.preventDefault(),await nr(i,e))}),document.addEventListener("dragstart",e=>{let t=e.target.closest("[data-ranked-workspace-id]");if(!t||!e.dataTransfer||!p)return;let n=t.dataset.rankedWorkspaceId;Rt=!0,Fn(n),e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",n),t.classList.add("is-dragging")}),m.rankedEndRunModal?.addEventListener("hidden.bs.modal",()=>{Bt(!1)}),document.addEventListener("dragend",e=>{e.target.closest("[data-ranked-workspace-id]")?.classList.remove("is-dragging"),An=Date.now()+350,Rt=!1,At(),W()}),document.addEventListener("dragover",e=>{let t=Ct(e.target);t&&(e.preventDefault(),W(),t.classList.add("is-drag-over"))}),document.addEventListener("dragleave",e=>{let t=Ct(e.target);t&&!t.contains(e.relatedTarget)&&t.classList.remove("is-drag-over")}),document.addEventListener("drop",e=>{let t=Ct(e.target);if(!t)return;e.preventDefault();let n=e.dataTransfer?.getData("text/plain");n&&(Rt=!1,At(),Rr(n,t,{x:e.clientX,y:e.clientY}))}),document.addEventListener("pointerdown",Es),document.addEventListener("pointermove",As),document.addEventListener("pointerup",Ms),document.addEventListener("pointercancel",Ts),document.addEventListener("keydown",e=>{let t=e.target.closest(".dungeon-demon-card[data-instance-id]");!t||!["Enter"," "].includes(e.key)||(e.preventDefault(),vr(t))}),document.addEventListener("scroll",e=>{let t=e.target?.closest?.("[data-ranked-pact-scroll-viewport]");t&&hr(t.closest(".ranked-reserve-buffs-shell"))},{capture:!0,passive:!0}),window.addEventListener("resize",fr)}async function Vi(){Bn(!0);try{let[e]=await Promise.all([Dt("/api/ranked/bootstrap"),qi().catch(t=>(console.warn("Ranked upgrade previews will use current-card art.",t),null))]);e.player&&Nn(e.player),ot=e.rating||null,e.run?(Oe(e.run),e.run.status==="active"&&e.run.phase==="result"&&!e.run.awaitingVictoryChoice&&await lr()):(s.run=null,k=null),Bn(!1),_(),k?.awaitingVictoryChoice&&kr(k)}catch(e){Bn(!1),Tt(e)}}async function qi(){return Fe||(wt||(wt=Dt("/api/game/catalog?v=20260722-request-optimization-v1").then(e=>(Fe={types:e?.types||{},demons:Array.isArray(e?.demons)?e.demons:[]},Fe)).catch(e=>{throw wt=null,e})),wt)}async function Yi(){let e=await mr("/api/ranked/start",{});e?.run&&Oe(e.run)}async function nr(e,t=null){if(G)return;let n=e.dataset.rankedAction;if(n==="start")return Yi();if(k){if(n==="reroll")return Ki(Ge(t,e));if(n==="lock-hand")return Xi();if(n==="fight")return dr();if(n==="continue")return lr();if(n==="end")return ji();if(n==="pact")return Ui(e.dataset.buffId)}}function ji(){if(!k||!m.rankedEndRunModal||!window.bootstrap?.Modal)return;let e=Math.max(1,Number(k.floor)||1),t=Number(k.rating?.projectedRunDelta??k.rating?.runDelta)||0,n=Math.max(0,Number(k.rating?.projectedEnd??k.rating?.rating)||0);m.rankedEndRunEyebrow&&(m.rankedEndRunEyebrow.textContent=`Concede \xB7 Floor ${P(e)}`),m.rankedEndRunSummary&&(m.rankedEndRunSummary.textContent=`Ending now calculates your final rank from reaching Floor ${P(e)} and retires this temporary roster.`),m.rankedEndRunFloor&&(m.rankedEndRunFloor.textContent=P(e)),m.rankedEndRunGain&&(m.rankedEndRunGain.textContent=Er(t),m.rankedEndRunGain.classList.toggle("is-negative",t<0)),m.rankedEndRunRating&&(m.rankedEndRunRating.textContent=P(n)),Bt(!1),window.bootstrap.Modal.getOrCreateInstance(m.rankedEndRunModal).show()}async function Wi(){if(G||!k||k.status!=="active")return;if(Bt(!0),(await He("end",{}))?.run?.status==="ended"){window.bootstrap?.Modal.getOrCreateInstance(m.rankedEndRunModal)?.hide();return}Bt(!1)}function Bt(e){let t=m.rankedEndRunModal;if(!t)return;t.querySelectorAll("button").forEach(a=>{a.disabled=!!e});let n=t.querySelector("[data-ranked-end-confirm]");n?.classList.toggle("is-busy",!!e),n?.setAttribute("aria-busy",e?"true":"false")}async function He(e,t){let n=await mr(`/api/ranked/runs/${encodeURIComponent(k.runId)}/${e}`,t);return n?.player&&Nn(n.player,{animate:!0}),n?.run&&(Oe(n.run),n.rewards?.souls&&Re(`Floor ${_e} cleared. ${n.rewards.souls} Souls awarded.`,"success")),n}async function lr(){let e=await He("continue",{});e?.run?.phase==="selection"&&e.run.floor>_e&&Re("Endless floor unlocked.","success")}async function Ui(e){let t=await He("pact",{buffId:e});return t?.run&&(de?.play("sfx.dungeon.pactChoose",{volume:.9}),Lr()),t}async function Ki(e){if(!Sr()||G)return;let t=await He("reroll",{lineup:wr(),lockHand:!!k.handLocked});if(!t?.run)return;let n=Math.max(0,Number(t.rerollCost)||Te);st(e,-n),de?.play("sfx.dungeon.pactReroll",{volume:.86})}async function dr(){if(!$r()||G||s.isBattleAnimating)return;at=0;let e=xs();ze(!0),ce=!0;try{let t=await Dt(`/api/ranked/runs/${encodeURIComponent(k.runId)}/battle`,gr({lineup:wr(),lockHand:!!k.handLocked}));if(!t?.run?.lastBattle)return;let n=t.rSoulInterest;Oe(t.run,{render:!1}),Number(n?.earned)>0&&(K=Math.max(0,Number(n.balanceBefore)||0));let a=t.run.lastBattle;ur(a),he("combat"),_(),await mt(),await hs(a.winner),Oe(t.run,{render:!1});let r=[];e.count&&r.push(`Auto-sold ${e.count} purchased Hand demon${e.count===1?"":"s"} for ${P(e.amount)} rSouls.`),t.rewards?.souls&&(r.push(`Victory milestone: ${t.rewards.souls} Souls awarded.`),t.player&&Nn(t.player,{animate:!0})),Number(n?.earned)>0&&(at=Math.max(0,Number(n.earned)||0)),Re(r.length?r.join(" "):"","success"),t.run.awaitingVictoryChoice&&kr(t.run,{rankGain:t.rankGain})}catch(t){Tt(t)}finally{ce=!1,ze(!1),_(),Lr()}}function Xi(){if(!k||!Mn(k))return;let e=!k.handLocked;k.handLocked=e,s.run.handLocked=e,_()}async function Zi(){let e=k?.lastBattle;if(!(G||s.isBattleAnimating||!e?.combatLog?.length)){ce=!0,ze(!0);try{ur(e),he("combat"),_(),m.fightLog.innerHTML="",m.fightLog.classList.remove("text-muted"),await mt(),Oe(k,{render:!1})}catch(t){Tt(t)}finally{ce=!1,ze(!1),_()}}}function ur(e){s.run.floor=Math.max(1,Number(e.floor)||Number(s.run.floor)||1),s.run.team=U(e.playerTeamBefore||s.run.team||[]),s.run.active=s.run.team,s.run.enemies=U(e.enemyTeamBefore||s.run.enemies||[]),s.combatLog=e.combatLog||[],s.combatDemons=Ze()}async function mr(e,t){ze(!0);try{return await Dt(e,gr(t))}catch(n){return Tt(n),null}finally{ze(!1)}}function gr(e){let t=_s();return{method:"POST",headers:{"Idempotency-Key":t},body:{...e,actionId:t}}}function Oe(e,t={}){At(),k=e,ot=e.rating||ot,K=Math.max(0,Math.floor(Number(e.rSouls)||0));let n=e.lastBattle;p=Mn(e)?vs(e):null,s.run={...e,team:U(p?.active||e.active||e.team),active:U(p?.active||e.active||e.team),reserve:U(p?.reserve||e.reserve),enemies:e.phase==="result"&&n?U(n.enemyTeamAfter):U(e.enemies)},s.combatLog=n?.combatLog||[],s.combatDemons=Ze(),t.render!==!1&&_(),ms(e.combinationEvents||[])}function _(){ks();let e=s.run,t=!!e;if(m.runEmpty.classList.toggle("d-none",t||s.isLoading),m.runPanel.classList.toggle("d-none",!t||s.isLoading),m.rankedBottomPanel.classList.toggle("d-none",!t||s.isLoading),!t){he("combat"),m.runEmpty.innerHTML=us();return}if((e.status==="ended"||e.phase==="ended")&&!ce){he("combat"),m.runPanel.classList.add("d-none"),m.rankedBottomPanel.classList.add("d-none"),m.runEmpty.classList.remove("d-none"),m.runEmpty.innerHTML=ds(e),rr([]);return}let n=ce||s.isBattleAnimating,a=n,r=!!(s.isPactTeamPreview&&e.pendingPact&&!a),o=a||r,i=!!(!o&&(e.lastBattle?.combatLog?.length||s.combatLog?.length));m.enemyGrid.closest(".battle-side")?.classList.toggle("is-ranked-reserve",!a),m.rankedBottomPanel.classList.toggle("is-ranked-combat",o),m.rankedBottomPanel.classList.remove("has-fight-review"),m.rankedBottomPanel.classList.toggle("is-battle-active",n),m.dungeonHandBar.classList.toggle("d-none",!o),m.dungeonHandBar.classList.toggle("is-battle-controls-mode",o),m.dungeonReplayLogBox.classList.add("d-none"),a||he("combat"),Ji(e),es(e,a),Br(),m.teamGrid.innerHTML=mn(e.team||e.active||[],{side:"player",allowFormationDrag:!a&&!e.pendingPact}),m.enemyGrid.innerHTML=a?mn(e.enemies||[],{side:"enemy"}):as(e.reserve||[],e),m.rankedPreparation.classList.toggle("d-none",a||r||e.phase==="preparation"&&s.isBattleAnimating);let c=!m.rankedPreparation.classList.contains("d-none"),d=Math.max(0,Math.min(3,Number(e.lives)||0)),l=Array.from({length:3},(g,u)=>`
    ...
    `).join("");m.rankedHandStatus.classList.toggle("d-none",!c),m.rankedHandStatus.setAttribute("aria-label",`${d} of 3 lives, ${P(K)} Ranked Souls`),m.rankedHandStatus.innerHTML=c?`
      ...
      ${Qi(e)}
    `:"",m.rankedPreparation.innerHTML=a||r?"":is(e,{canReviewFight:i}),yr(),br(),rr(e.pacts?.pendingChoices||[]),gs(),ws(),$s(),fr()}function Ji(e){let t=e.rating?.division||"Bronze II",n=it(t),a=Array.isArray(e.team)?e.team:e.active||[],r=Math.max(1,Number(e.capacities?.active)||6),o=Math.min(r,a.length),i=`${o}/${r}`,c=`
  ...
  `}function pr(e){let t=e.lockedBonuses||{},n=Object.values(t.allocations||{}).reduce((i,c)=>i+Math.max(0,Number(c)||0),0),a=fn({spentPoints:n,bonuses:t.skillBonuses||{}}),r=Aa(Array.isArray(e.pacts?.activeBuffs)?e.pacts.activeBuffs:[]),o=(Array.isArray(t.activeBuffs)?t.activeBuffs:[]).filter(i=>i?.source!=="skill_tree");return[...a?[a]:[],...r,...o].filter(i=>i?.id)}function ts(e){let t=Array.isArray(e.lastBattle?.enemyBuffs)?e.lastBattle.enemyBuffs:[],n=fn(e.lastBattle?.enemySkillTree);return n?[n,...t.filter(a=>a?.source!=="skill_tree")]:t}function ns(e){return Da(e,{stackClass:"ranked-pact-stack",countClass:"ranked-pact-stack-count"})}function as(e,t){let n=Array.from({length:t.capacities.reserve},()=>null),a=[];e.forEach(o=>{let i=ee(o.reserveSlot);i!==null&&!n[i]?n[i]=o:a.push(o)}),a.forEach(o=>{let i=n.findIndex(c=>!c);i>=0&&(n[i]=o)});let r=pr(t);return`
  ...
  `}function ss(e){return L(e?"lock":"lock-open")}function ar(e){let t=e?.rarityOdds||{};return`
