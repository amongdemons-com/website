(()=>{var bo=Object.defineProperty;var yo=(e,t)=>{for(var n in t)bo(e,n,{get:t[n],enumerable:!0})};var h={};function Cn(e){Object.assign(h,e)}var tt="amongdemons-battle-speed",Bn="amongdemons-battle-screen-shake",En="amongdemons-battle-card-shake";var Pe=[.5,1,2,4];var _e={default:{color:"#FAC51C",shadow:"rgba(250,197,28,0.85)"},poison:{color:"#167246",shadow:"rgba(22,114,70,0.92)"},heal:{color:"#8DE7FF",shadow:"rgba(141,231,255,0.86)",outline:"#0d2530"},1:{color:"#D1D5D8",shadow:"rgba(209,213,216,0.82)",outline:"#101820"},2:{color:"#171D24",shadow:"rgba(0,0,0,0.88)"},3:{color:"#167246",shadow:"rgba(22,114,70,0.92)"},4:{color:"#E25041",shadow:"rgba(226,80,65,0.88)"},5:{color:"#C8CED2",shadow:"rgba(200,206,210,0.82)",outline:"#101820"},6:{color:"#C084FC",shadow:"rgba(192,132,252,0.9)"},7:{color:"#FFB23F",shadow:"rgba(255,178,63,0.9)"},8:{color:"#6E8F45",shadow:"rgba(110,143,69,0.86)"},9:{color:"#B8BDC2",shadow:"rgba(184,189,194,0.84)",outline:"#101820"},10:{color:"#8DE7FF",shadow:"rgba(141,231,255,0.86)",outline:"#0d2530"},11:{color:"#52B7FF",shadow:"rgba(82,183,255,0.9)"}};var vo=window.AmongDemons.getSession(),i={player:vo.player||null,statPoints:null,run:null,startOptions:null,selectedRecruitRewardId:null,selectedSwapInstanceId:null,selectedRewardDemonKey:null,rewardDraftCandidate:null,isRecruiting:!1,isResultAnimating:!1,draggedRecruitPoolInstanceId:null,draggedFormationInstanceId:null,draggedRewardDemonKey:null,recruitSwapEffectIds:[],pendingHandFlowSources:null,isEnemyPreviewDeferred:!1,enemyRevealEffectIds:[],isPactRevealPending:!1,isPactTeamPreview:!1,pactRevealTimer:null,battleHandPreview:null,activeHandTab:"hand",isMobileRewardBoxOpen:!1,recruitDraftTeam:null,recruitDraftPool:null,collectionDemons:null,collectionReinforcementPlaceholderInteracted:!1,collectionReinforcementStagedInteracted:!0,isRecruitContinuePending:!1,combatLog:[],combatDemons:new Map,combatPlayback:null,battleSpeed:wo(),isBattleAnimating:!1,endNotice:null,endSummary:null,endedReplayRun:null,formationRows:new Map,isLoading:!0},b={},ue=null;function An(e){ue=e}function wo(){let e=Number(localStorage.getItem(tt));return Pe.includes(e)?e:1}var Xt={};yo(Xt,{animateAttackerCard:()=>Vn,animateCombatEntry:()=>_n,appendTemporaryElement:()=>Y,applyBattleSpeed:()=>lt,applyCombatTheme:()=>qt,createCombatDemonMap:()=>Ye,createCombatElement:()=>q,drawAttackZap:()=>Le,drawChaoticLightning:()=>na,drawCombatAnimation:()=>jo,drawDarkSpike:()=>aa,drawFireNova:()=>ea,drawFireball:()=>Jn,drawGroupFireball:()=>Qn,drawHealEffect:()=>ta,drawSwordSwing:()=>Gt,drawThornBurst:()=>Tt,findDemonCard:()=>C,formatBattleSpeed:()=>Jo,getAttackGeometry:()=>Ve,getAttackProfile:()=>Ge,getBattleTimeScale:()=>Wt,getCombatDemon:()=>X,getCombatStepDelay:()=>Yt,getCombatTheme:()=>Vt,getDemonSide:()=>oe,getFightLogActionText:()=>ia,getFightLogAmountText:()=>ca,getFightLogVerb:()=>sa,getLogRowClass:()=>la,getLogSideLabel:()=>da,getPoisonBurstDamage:()=>Ut,groupCombatLog:()=>qe,healTargetCard:()=>At,hitTargetCard:()=>Un,isCardShakeEnabled:()=>Wn,isScreenShakeEnabled:()=>Kn,isTypeTwoAttack:()=>oa,maybePlayDeath:()=>Zn,pauseCombatPlayback:()=>Nt,playCombatLog:()=>rt,playTemporaryCardClass:()=>ge,poisonTickCard:()=>Et,prefersReducedMotion:()=>z,prepareCombatPlayback:()=>Nn,renderFightLogDemonName:()=>Mt,renderFightLogRow:()=>Kt,renderLogPosition:()=>ra,renderViewportSvg:()=>re,resumeCombatPlayback:()=>_t,scaleCombatDuration:()=>V,scheduleImpact:()=>ke,setActiveLogRow:()=>ct,setBattleSpeed:()=>jt,shakeTargetCard:()=>Zo,showFloatingDamage:()=>Oe,skipCombatPlayback:()=>Ot,spawnImpactBurst:()=>Bt,stepCombatPlayback:()=>Ht,syncBattleSpeedButtons:()=>dt,syncCombatHpCards:()=>Gn,syncPoisonStatus:()=>Dt,triggerScreenShake:()=>Xn,updateTargetCard:()=>me,updateTeamHp:()=>zn});var ko=window.AmongDemons.api;var Dn=window.AmongDemons.ui.renderDemonCard,$o=window.AmongDemons.ui.renderCombatStats,ks=window.AmongDemons.ui.openDemonDetailsModal,x=window.AmongDemons.ui.renderIcon||(()=>""),St=window.AmongDemons.ui.renderSoulAmount||(e=>String(e||0)),Pt=window.AmongDemons.ui.getRarityColor||(()=>"#D1D5D8");var ne=new WeakMap;function Tn(){i.endNotice=null,i.endSummary=null,i.endedReplayRun=null}function N(e,t){e&&e.addEventListener("click",t)}function nt(e,t,n=document){n.querySelectorAll(e).forEach(a=>{a.addEventListener("click",o=>t(a,o))})}function Q(e,t,n={}){if(!e)return!1;let a=String(t||""),o=n.renderKey?String(n.renderKey):"",r=Re(a,o);return ne.get(e)===r?!1:(n.patchFormationGrid?Po(e,a,o):n.patchDemonLane?Ro(e,a,o):n.preserveDemonImages?So(e,a):e.innerHTML=a,ne.set(e,r),!0)}function So(e,t){let n=He(e),a=document.createElement("template");a.innerHTML=t,we(a.content,n),e.replaceChildren(a.content)}function Po(e,t,n=""){let a=document.createElement("template");a.innerHTML=t;let o=e.querySelector(".battle-formation-grid"),r=a.content.querySelector(".battle-formation-grid");if(!o||!r){let u=He(e);we(a.content,u),e.replaceChildren(a.content),xo(e.querySelector(".battle-formation-grid"),n);return}let s=He(e);xt(o,r);let c=Rt(o),l=new Map(c.map(u=>[u.dataset.formationSlot,u])),d=Rt(r),m=new Set(d.map(u=>u.dataset.formationSlot));d.forEach((u,f)=>{let S=u.dataset.formationSlot,y=l.get(S);if(!y){we(u,s),o.insertBefore(u,o.children[f]||null);return}y!==o.children[f]&&o.insertBefore(y,o.children[f]||null);let w=u.outerHTML,v=Re(w,n);(ne.get(y)||y.outerHTML)!==v&&(we(u,s),ne.set(u,v),y.replaceWith(u))}),c.forEach(u=>{m.has(u.dataset.formationSlot)||u.remove()})}function Ro(e,t,n=""){let a=document.createElement("template");a.innerHTML=t;let o=e.querySelector(".formation-lane-cards"),r=a.content.querySelector(".formation-lane-cards");if(!o||!r){let c=He(e);we(a.content,c),e.replaceChildren(a.content),Co(e.querySelector(".formation-lane-cards"),n);return}let s=He(e);xt(o,r),Lo(o,Array.from(r.children),{imagesByKey:s,renderKey:n,getKey:Bo})}function Rt(e){return e?Array.from(e.children).filter(t=>t.matches?.(".formation-slot[data-formation-slot]")):[]}function xo(e,t=""){Rt(e).forEach(n=>{ne.set(n,Re(n.outerHTML,t))})}function Lo(e,t,n={}){let{imagesByKey:a=new Map,renderKey:o="",getKey:r}=n,s=Array.from(e.children),c=new Map(s.map((d,m)=>[r(d,m),d])),l=new Set(t.map((d,m)=>r(d,m)));t.forEach((d,m)=>{let u=r(d,m),f=c.get(u);if(!f){we(d,a),ne.set(d,Re(d.outerHTML,o)),e.insertBefore(d,e.children[m]||null);return}f!==e.children[m]&&e.insertBefore(f,e.children[m]||null);let S=d.outerHTML,y=Re(S,o);(ne.get(f)||f.outerHTML)!==y&&(we(d,a),ne.set(d,y),f.replaceWith(d))}),s.forEach((d,m)=>{l.has(r(d,m))||d.remove()})}function Co(e,t=""){e&&Array.from(e.children).forEach(n=>{ne.set(n,Re(n.outerHTML,t))})}function Bo(e,t=0){let n=e.dataset?.instanceId;if(n)return`demon:${n}`;let a=e.dataset?.collectionReinforcementPosition;return a?`collection-reinforcement:${a}`:e.classList?.contains("dungeon-hand-empty")?"empty:hand":`node:${t}`}function Re(e,t=""){return t?`${t}
${e}`:e}function He(e){let t=new Map;return e.querySelectorAll(".dungeon-demon-card[data-instance-id] .dungeon-demon-card-image img").forEach(n=>{let a=Mn(n);a&&!t.has(a)&&t.set(a,n)}),t}function we(e,t){e.querySelectorAll(".dungeon-demon-card[data-instance-id] .dungeon-demon-card-image img").forEach(n=>{let a=Mn(n),o=a?t.get(a):null;o&&(xt(o,n),n.replaceWith(o),t.delete(a))})}function Mn(e){let n=e.closest(".dungeon-demon-card[data-instance-id]")?.dataset.instanceId,a=e.getAttribute("src")||"";return n&&a?`${n}|${a}`:""}function xt(e,t){Array.from(e.attributes).forEach(n=>{t.hasAttribute(n.name)||e.removeAttribute(n.name)}),Array.from(t.attributes).forEach(n=>{e.getAttribute(n.name)!==n.value&&e.setAttribute(n.name,n.value)})}function xe(e){e&&(e.disabled=!1)}function at(e){return e?e.charAt(0).toUpperCase()+e.slice(1):""}function k(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Fn(e){return window.CSS?.escape?window.CSS.escape(String(e)):String(e).replace(/["\\]/g,"\\$&")}function Lt(e){return(e||[]).map(t=>({...t}))}var Ce=window.AmongDemons.audio,Eo="amongdemons:battle-intro-complete";var Ft=(...e)=>h.getDemonPosition(...e),Ao=(...e)=>h.renderDemonStatus(...e),Do=(...e)=>h.renderDungeonCenterActions(...e),Ct=(...e)=>h.renderFightLog(...e),Be=(...e)=>h.renderFightLogActions(...e),ze=(...e)=>h.renderRun(...e);function Nn(e={}){if(!i.run)return null;let t=qe(i.combatLog,{combineCounters:!0}),n={currentIndex:0,isPaused:!1,stepDirection:0,steps:t,totalSteps:t.length,waitResolve:null};return i.combatPlayback=n,i.isBattleAnimating=!0,e.render!==!1&&(ze(),Ct()),n}async function rt(e={}){if(!i.run)return;let t=e.combatPlayback,n=t&&i.combatPlayback===t?t:Nn({render:!1});if(!n)return;let a=n.steps||[];if(i.isBattleAnimating=!0,ze(),Ct(),e.waitForBattleIntro){if(Do({canFight:!0,isFighting:!0}),await Ce?.play("sfx.battle.battleStart",{volume:.9,waitForEnd:!0}),!i.run||i.combatPlayback!==n)return;window.dispatchEvent(new CustomEvent(Eo))}ze(),Ct();try{for(;i.combatPlayback&&i.combatPlayback.currentIndex<a.length;){let o=await Ho();if(!o||!i.combatPlayback)break;if(o==="previous"){await zo();continue}let r=i.combatPlayback.currentIndex,s=a[r];if(!s)break;U(!1),It(s,r,{animate:!0}),i.combatPlayback.currentIndex=r+1,Be(),await Hn(V(Yt(s))),U(!!i.combatPlayback?.isPaused)}}finally{i.isBattleAnimating=!1,i.combatPlayback=null,U(!1),ze()}ct(-1)}function It(e,t=-1,n={}){let a=Vo(),o=n.animate!==!1;if(e.entries.forEach(u=>{let f=a.get(u.target);f&&(f.hp=u.targetHp,u.effect==="poison_apply"&&(f.statusEffects=f.statusEffects||{},f.statusEffects.poison=Array.from({length:Math.max(1,Number(u.poisonStacks)||1)},()=>({}))),u.effect==="poison"&&Object.prototype.hasOwnProperty.call(u,"poisonStacks")&&(f.statusEffects=f.statusEffects||{},f.statusEffects.poison=Array.from({length:Math.max(0,Number(u.poisonStacks)||0)},()=>({}))))}),zn(),!o){Gn();return}ct(t);let r=oe(e.attacker),s=it(e),c=new Map(s.map((u,f)=>[u,f])),l=!!e.isAoe||s.length>1;To(e),e.primaryEffect!=="poison"&&Vn(e.attacker,e.primaryEffect,e.entries[0]?.target);let d=Fo(e);d&&Qn(e.attacker,d.targetIds,{effect:e.primaryEffect,travel:d.travel});let m=Io(e);m&&Gt(e.attacker,m.targetId),e.entries.forEach(u=>{let f=c.get(u)??0;_n(u,e,r,f,l,d,m)})}function To(e){let t=e.entries?.[0]||{},n=e.primaryEffect||t.effect;if(n==="poison"||n==="heal"||n==="last_breath"||n==="shared_pain")return;let a=null;if(n==="poison_apply")a="sfx.battle.abilities.poisonApply";else if(n==="retaliate"||n==="thorns")a="sfx.battle.abilities.thornsRetaliate";else{let o=Number(X(e.attacker)?.typeId);a={1:"sfx.battle.abilities.meleeSwing",2:"sfx.battle.abilities.rangedProjectile",3:"sfx.battle.abilities.poisonApply",4:"sfx.battle.abilities.fireAoe",5:"sfx.battle.abilities.bruiserStrike",6:"sfx.battle.abilities.assassinStrike",7:"sfx.battle.abilities.cleave",8:"sfx.battle.abilities.thornsRetaliate",9:"sfx.battle.abilities.juggernautSlam",10:"sfx.battle.abilities.heal",11:"sfx.battle.abilities.chaosAttack"}[o]||"sfx.battle.abilities.meleeSwing"}Ce?.play(a,{volume:.72,minInterval:55}),!ae(t)&&(e.entries||[]).some(ae)&&Ce?.play("sfx.battle.abilities.thornsRetaliate",{volume:.66,minInterval:55})}var Mo=new Set(["poison","heal","last_breath","shared_pain","poison_apply"]);function ae(e){return e?.effect==="retaliate"||e?.effect==="thorns"}function it(e){return(e.entries||[]).filter(t=>!ae(t))}function ot(e){return!ae(e)&&!Mo.has(e.effect)}function Fo(e){if(z()||e.targeting==="chaotic"||Number(X(e.attacker)?.typeId)!==4)return null;let t=(e.entries||[]).filter(ot);return t.length?{targetIds:t.map(n=>n.target),travel:Ge(t[0]).travel,lead:90}:null}function Io(e){if(z()||Number(X(e.attacker)?.typeId)!==7)return null;let t=(e.entries||[]).filter(ot);return t.length?{targetId:t[Math.floor((t.length-1)/2)].target}:null}function _n(e,t,n,a,o,r=null,s=null){let c=z();if(e.effect==="poison"){ke(160,()=>{a===0&&Ce?.play("sfx.battle.abilities.poisonTick",{volume:.66,minInterval:80}),a===0&&Oe(e.target,Ut(t),"poison",e.attacker,e.effect,{burstCount:t.entries.length}),me(e.target,e.targetHp,n,{hit:!1}),Dt(e.target,e.poisonStacks),Et(e.target)});return}if(e.effect==="heal"){c||ta(e.attacker,e.target),ke(200,()=>{Ce?.play("sfx.battle.abilities.heal",{volume:.7,minInterval:80}),me(e.target,e.targetHp,n,{hit:!1,healing:e.healing}),Oe(e.target,e.healing,"heal",e.attacker,e.effect),At(e.target)});return}if(e.effect==="last_breath"){ke(160,()=>{me(e.target,e.targetHp,n,{hit:!1}),Oe(e.target,1,"heal",e.attacker,e.effect),At(e.target)});return}if(e.effect==="shared_pain"){me(e.target,e.targetHp,n,{hit:!1});return}if(e.effect==="poison_apply"){c||Le(t.attacker,e.target,{effect:e.effect,poison:!0,bubbles:15,variant:"poison-flame"}),ke(220,()=>{Dt(e.target,e.poisonStacks||1),me(e.target,e.targetHp,n),Bt(e.target,{attackerId:e.attacker,effect:e.effect,variant:"poison"}),Et(e.target)});return}let l=Ge(e),d=r&&ot(e),m=s&&ot(e),u=d||m,f=!ae(e)||No(e,t);!c&&!u&&f&&l.draw();let S=d?r.travel+r.lead+a*50:l.travel+(o?a*70:0);ke(S,()=>{me(e.target,e.targetHp,n),Number(e.dmg)>0&&Oe(e.target,e.dmg,oa(e.attacker)?"dark":"damage",e.attacker,e.effect),Bt(e.target,{attackerId:e.attacker,effect:e.effect,heavy:l.heavy,variant:l.key,aoe:o&&!ae(e)}),Un(e.target,l.heavy),l.screenShake&&Xn(),Zn(e.target,e.targetHp)})}function No(e,t){if(!ae(e))return!0;let n=(t?.entries||[]).filter(ae),a=n.filter(r=>r.effect==="retaliate"||_o(r.attacker));return(a.length?a:n).find(r=>r.attacker===e.attacker)===e}function _o(e){let t=X(e)||{},n=String(t.role||"").toLowerCase(),a=String(t.abilityKind||t.ability_kind||t.ability?.kind||"").toLowerCase();return Number(t.typeId)===8||n==="counter_tank"||a==="retaliate"}async function Ho(){for(;i.combatPlayback?.isPaused;){U(!0);let e=Number(i.combatPlayback.stepDirection)||0;if(i.combatPlayback.stepDirection=0,e<0)return"previous";if(e>0)return i.combatPlayback.currentIndex<i.combatPlayback.totalSteps?"next":null;await Oo()}return U(!1),i.combatPlayback?"play":null}function Hn(e){let t=i.combatPlayback;return t?new Promise(n=>{let a=window.setTimeout(o,Math.max(0,Number(e)||0));function o(){window.clearTimeout(a),t.waitResolve===o&&(t.waitResolve=null),n()}t.waitResolve=o}):Promise.resolve()}function Oo(){let e=i.combatPlayback;return e?new Promise(t=>{e.waitResolve=()=>{e.waitResolve=null,t()}}):Promise.resolve()}function Nt(){!i.combatPlayback||!i.isBattleAnimating||(i.combatPlayback.isPaused=!0,U(!0),st(),Be())}function _t(){!i.combatPlayback||!i.isBattleAnimating||(i.combatPlayback.isPaused=!1,i.combatPlayback.stepDirection=0,U(!1),st(),Be())}function Ht(e){!i.combatPlayback||!i.isBattleAnimating||(i.combatPlayback.isPaused=!0,i.combatPlayback.stepDirection=Number(e)<0?-1:1,U(!0),st(),Be())}function Ot(){let e=i.combatPlayback;!i.run||!e||!i.isBattleAnimating||(e.isPaused=!1,e.stepDirection=0,On(e.totalSteps),U(!1),st())}function st(){let e=i.combatPlayback?.waitResolve;e&&e()}function On(e){if(!i.run||!i.combatPlayback)return;qo(),Go();let t=i.combatPlayback.steps||[],n=zt(Math.floor(Number(e)||0),0,t.length);for(let a=0;a<n;a+=1)It(t[a],a,{animate:!1});i.combatPlayback.currentIndex=n,ze(),ct(n>0?n-1:-1)}async function zo(){let e=i.combatPlayback;if(!i.run||!e||e.currentIndex<=0)return;let t=e.steps||[],n=zt(e.currentIndex-2,0,t.length-1),a=t[n];a&&(On(n),U(!1),It(a,n,{animate:!0}),e.currentIndex=n+1,Be(),await Hn(V(Yt(a))),i.combatPlayback&&(i.combatPlayback.isPaused=!0,U(!0),Be()))}function Go(){let e=i.run?.lastBattle||{};i.run.team=Lt(e.playerTeamBefore||i.run.team||[]),i.run.enemies=Lt(e.enemyTeamBefore||i.run.enemies||[]),i.combatDemons=Ye()}function Vo(){return new Map([...i.run?.team||[],...i.run?.enemies||[]].map(e=>[e.instanceId,e]))}function qo(){Xo(),document.querySelectorAll([".attack-zap",".chaos-lightning",".combat-impact-burst",".dark-spike",".fireball-shot",".fire-nova",".floating-combat-number",".heal-effect",".sword-swing",".thorn-burst"].join(",")).forEach(e=>e.remove()),document.querySelector(".dungeon-arena")?.classList.remove("is-combat-screenshake")}function U(e){let t=!!e;document.documentElement.classList.toggle("is-combat-paused",t),t?Ko():Uo()}function zt(e,t,n){return Math.max(t,Math.min(n,Number(e)||0))}function zn(){i.run&&(i.run.hp=(i.run.team||[]).reduce((e,t)=>e+Math.max(0,Number(t.hp)||0),0))}function Gn(){[...i.run?.team||[],...i.run?.enemies||[]].forEach(e=>{me(e.instanceId,e.hp)})}function ct(e){document.querySelectorAll(".fight-log-row").forEach(t=>{t.classList.toggle("active",Number(t.dataset.logIndex)===e)})}function Vn(e,t,n){let a=C(e);a&&(qt(a,Vt(e,t)),a.classList.toggle("is-player-attack",oe(e)==="player"),a.classList.toggle("is-enemy-attack",oe(e)==="enemy"),Yo(a,n),ge(a,"is-attacking",320))}function Yo(e,t){if(z()||!t){e.style.setProperty("--lunge-x","0px"),e.style.setProperty("--lunge-y","0px");return}let n=C(t);if(!n){e.style.setProperty("--lunge-x","0px"),e.style.setProperty("--lunge-y","0px");return}let a=e.getBoundingClientRect(),o=n.getBoundingClientRect(),r=o.left+o.width/2-(a.left+a.width/2),s=o.top+o.height/2-(a.top+a.height/2),c=Math.hypot(r,s)||1,l=Math.min(18,c*.26);e.style.setProperty("--lunge-x",`${(r/c*l).toFixed(1)}px`),e.style.setProperty("--lunge-y",`${(s/c*l).toFixed(1)}px`)}function Ge(e){let{attacker:t,target:n,effect:a}=e;if(ae(e))return{key:"thorn",travel:210,heavy:!1,screenShake:!1,draw:()=>Tt(t,n)};if(e.targeting==="chaotic")return{key:"chaotic",travel:150,heavy:!0,screenShake:!1,draw:()=>na(t,n)};let o=Number(X(t)?.typeId);return{2:{key:"dark",travel:200,heavy:!1,draw:()=>aa(t,n)},4:{key:"fire",travel:380,heavy:!0,screenShake:!1,draw:()=>Jn(t,n,{effect:a})},5:{key:"sniper",travel:360,heavy:!0,draw:()=>Le(t,n,{effect:a,variant:"heavy",duration:520})},6:{key:"assassin",travel:120,heavy:!1,draw:()=>Le(t,n,{effect:a,variant:"assassin",duration:240})},7:{key:"melee",travel:170,heavy:!1,draw:()=>Gt(t,n)},8:{key:"thorn",travel:210,heavy:!1,draw:()=>Tt(t,n)},9:{key:"crushing",travel:620,heavy:!0,screenShake:!0,draw:()=>Le(t,n,{effect:a,variant:"crushing",duration:960})}}[o]||{key:"melee",travel:150,heavy:!1,draw:()=>Le(t,n,{effect:a})}}function jo(e){Ge(e).draw()}function z(){return!!(window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches)}var Ee=new Set;function qn(){return window.performance?.now?.()??Date.now()}function ke(e,t){let n=V(e);if(z()||n<=0){t();return}let a={fn:t,remaining:n,startedAt:0,handle:null};a.run=()=>{a.handle=null,Ee.delete(a),a.fn()},Ee.add(a),Wo()||Yn(a)}function Yn(e){e.startedAt=qn(),e.handle=window.setTimeout(e.run,e.remaining)}function Wo(){return document.documentElement.classList.contains("is-combat-paused")}function Ko(){Ee.forEach(e=>{e.handle!=null&&(window.clearTimeout(e.handle),e.handle=null,e.remaining=Math.max(0,e.remaining-(qn()-e.startedAt)))})}function Uo(){Ee.forEach(e=>{e.handle==null&&Yn(e)})}function Xo(){Ee.forEach(e=>{e.handle!=null&&window.clearTimeout(e.handle)}),Ee.clear()}function Bt(e,t={}){if(z())return;let n=C(e);if(!n)return;let a=n.getBoundingClientRect(),o=q(["combat-impact-burst",t.heavy?"is-heavy":"",t.aoe?"is-aoe":"",`is-${t.variant||"melee"}`].filter(Boolean).join(" "),t.attackerId,t.effect);o.style.left=`${(a.left+a.width/2).toFixed(1)}px`,o.style.top=`${(a.top+a.height/2).toFixed(1)}px`;let r=t.heavy?520:380;o.style.setProperty("--fx-duration",`${V(r)}ms`);let s=t.heavy?9:6,c=t.heavy?26:17,l=Array.from({length:s},(d,m)=>{let u=360/s*m+(m%2?14:-10),f=c+m%3*5;return`<span class="combat-impact-particle" style="--p-angle:${u.toFixed(0)}deg;--p-dist:${f}px;animation-delay:${V(m*6)}ms"></span>`}).join("");o.innerHTML=`<span class="combat-impact-core"></span>${t.aoe?'<span class="combat-impact-ring"></span>':""}${l}`,Y(o,r)}function jn(e){try{return localStorage.getItem(e)!=="0"}catch{return!0}}function Wn(){return jn(En)}function Kn(){return jn(Bn)}function Un(e,t){if(z())return;let n=C(e);if(!n)return;let a=Wn();ge(n,t&&a?"is-shaking":"is-hit",t&&a?360:240)}function Et(e){if(z())return;let t=C(e);t&&ge(t,"is-poison-tick",520)}function At(e){if(z())return;let t=C(e);t&&ge(t,"is-healed",520)}var In=0;function Xn(){if(z()||!Kn())return;let e=window.performance?.now?.()??Date.now();if(e-In<140)return;In=e;let t=document.querySelector(".dungeon-arena");t&&ge(t,"is-combat-screenshake",360)}function Zn(e,t){if(Number(t)>0)return;let n=C(e);!n||n.classList.contains("is-dying")||(Ce?.playDeath(),!z()&&ge(n,"is-dying",620))}function Le(e,t,n={}){let a=C(e),o=C(t);if(!a||!o)return;let{attackerRect:r,startX:s,startY:c,endX:l,endY:d}=Ve(a,o),m=X(e),u=m&&Ft(m)==="back",f=u?.12:.22,S=u?.9:.78,y=s+(l-s)*f,w=c+(d-c)*f,v=s+(l-s)*S,P=c+(d-c)*S,A=(y+v)/2,T=(w+P)/2,D=-(P-w)/Math.max(1,Math.hypot(v-y,P-w)),I=(v-y)/Math.max(1,Math.hypot(v-y,P-w)),K=u?10:6,ee=A+D*K,te=T+I*K,le=Number(n.bubbles)||0,Se=le?Array.from({length:le},(he,H)=>{let L=.08+H/Math.max(1,le-1)*.84,be=(1-L)*(1-L)*y+2*(1-L)*L*ee+L*L*v,$t=(1-L)*(1-L)*w+2*(1-L)*L*te+L*L*P,Ne=(H%2?-1:1)*(4+H%4),G=2.2+H%4*.8;return`<circle class="poison-bubble" cx="${(be+D*Ne).toFixed(1)}" cy="${($t+I*Ne).toFixed(1)}" r="${G.toFixed(1)}" style="animation-delay: ${V(H*18).toFixed(0)}ms" />`}).join(""):"",_=Number(n.flames)||0,B=_?Array.from({length:_},(he,H)=>{let L=.08+H/Math.max(1,_-1)*.84,be=(1-L)*(1-L)*y+2*(1-L)*L*ee+L*L*v,$t=(1-L)*(1-L)*w+2*(1-L)*L*te+L*L*P,Ne=(H%2?-1:1)*(5+H%3*2),G=5+H%4,ye=be+D*Ne,ve=$t+I*Ne;return`<path class="fire-spark" d="M ${ye.toFixed(1)} ${(ve-G).toFixed(1)} C ${(ye+G*.72).toFixed(1)} ${(ve-G*.2).toFixed(1)} ${(ye+G*.45).toFixed(1)} ${(ve+G*.72).toFixed(1)} ${ye.toFixed(1)} ${(ve+G).toFixed(1)} C ${(ye-G*.55).toFixed(1)} ${(ve+G*.42).toFixed(1)} ${(ye-G*.45).toFixed(1)} ${(ve-G*.32).toFixed(1)} ${ye.toFixed(1)} ${(ve-G).toFixed(1)} Z" style="animation-delay: ${V(H*16).toFixed(0)}ms" />`}).join(""):"",de=q(["attack-zap",oe(e)==="player"?"is-player-attack":"is-enemy-attack",u?"is-back-attack":"",n.variant?`is-${n.variant}`:"",n.poison?"is-poison-apply":""].filter(Boolean).join(" "),e,n.effect);de.innerHTML=re(`
      <path class="attack-zap-trail" d="M ${y.toFixed(1)} ${w.toFixed(1)} Q ${ee.toFixed(1)} ${te.toFixed(1)} ${v.toFixed(1)} ${P.toFixed(1)}" />
      ${n.variant==="assassin"?`<path class="attack-zap-trail attack-zap-trail-secondary" d="M ${(y+D*7).toFixed(1)} ${(w+I*7).toFixed(1)} Q ${(ee+D*7).toFixed(1)} ${(te+I*7).toFixed(1)} ${(v+D*7).toFixed(1)} ${(P+I*7).toFixed(1)}" />`:""}
      ${Se}
      ${B}
      <circle class="attack-zap-impact" cx="${v.toFixed(1)}" cy="${P.toFixed(1)}" r="${u?5:4}" />
  `),Y(de,n.duration||320)}function Jn(e,t,n={}){let a=C(e),o=C(t);if(!a||!o)return;let{attackerRect:r,targetRect:s,startX:c,startY:l,endX:d,endY:m,angle:u}=Ve(a,o),f=X(e),S=f&&Ft(f)==="back",y=Math.min(r.width*(S?.28:.42),46),w=Math.min(s.width*.18,22),v=c+Math.cos(u)*y,P=l+Math.sin(u)*y,A=d-Math.cos(u)*w,T=m-Math.sin(u)*w,D=Math.max(1,Math.hypot(A-v,T-P)),I=-(T-P)/D,K=(A-v)/D,ee=Math.max(12,Math.min(24,s.width*.18)),te=8,le=Array.from({length:te},(_,B)=>{let de=.12+B/Math.max(1,te-1)*.72,he=(B%2?-1:1)*(4+B%3*2),H=v+(A-v)*de+I*he,L=P+(T-P)*de+K*he,be=1.8+B%3*.8;return`<circle class="fireball-ember" cx="${H.toFixed(1)}" cy="${L.toFixed(1)}" r="${be.toFixed(1)}" style="animation-delay: ${V(70+B*28).toFixed(0)}ms" />`}).join(""),Se=q(["fireball-shot",oe(e)==="player"?"is-player-attack":"is-enemy-attack",S?"is-back-attack":""].filter(Boolean).join(" "),e,n.effect);Se.innerHTML=re(`
      ${le}
  ...
  `),Y(Se,620)}function Qn(e,t,n={}){let a=C(e),o=(t||[]).map(C).filter(Boolean);if(z()||!a||!o.length)return;let r=a.getBoundingClientRect(),s=r.left+r.width/2,c=r.top+r.height/2,l=o.map(_=>{let B=_.getBoundingClientRect();return{x:B.left+B.width/2,y:B.top+B.height/2,half:Math.max(B.width,B.height)/2}}),d=l.reduce((_,B)=>_+B.x,0)/l.length,m=l.reduce((_,B)=>_+B.y,0)/l.length,u=Math.atan2(m-c,d-s),f=X(e),S=f&&Ft(f)==="back",y=Math.min(r.width*(S?.28:.42),46),w=s+Math.cos(u)*y,v=c+Math.sin(u)*y,P=d,A=m,T=Math.max(1,Math.hypot(P-w,A-v)),D=-(A-v)/T,I=(P-w)/T,K=zt(Math.max(...l.map(_=>Math.hypot(_.x-d,_.y-m)+_.half))+8,44,220),ee=9,te=Array.from({length:ee},(_,B)=>{let de=.12+B/Math.max(1,ee-1)*.72,he=(B%2?-1:1)*(4+B%3*2),H=w+(P-w)*de+D*he,L=v+(A-v)*de+I*he,be=1.8+B%3*.8;return`<circle class="fireball-ember" cx="${H.toFixed(1)}" cy="${L.toFixed(1)}" r="${be.toFixed(1)}" style="animation-delay: ${V(70+B*28).toFixed(0)}ms" />`}).join(""),le=q(["fireball-shot",oe(e)==="player"?"is-player-attack":"is-enemy-attack",S?"is-back-attack":""].filter(Boolean).join(" "),e,n.effect);le.innerHTML=re(`
      ${te}
      <g class="fireball-projectile" style="--fireball-start-x: ${w.toFixed(1)}px; --fireball-start-y: ${v.toFixed(1)}px; --fireball-end-x: ${P.toFixed(1)}px; --fireball-end-y: ${A.toFixed(1)}px;">
  ...
  `),Y(v,440)}function Tt(e,t){let n=C(e),a=C(t);if(!n||!a)return;let{attackerRect:o,startX:r,startY:s,angle:c}=Ve(n,a),l=Math.max(42,o.width*.5),d=r+Math.cos(c)*l,m=s+Math.sin(c)*l,u=Math.max(22,o.width*.28),f=q("thorn-burst",e),S=[-.48,-.28,-.1,.1,.28,.48];f.innerHTML=re(`
      ${S.map((y,w)=>{let v=c+y,P=u*(.74+w%2*.16),A=o.height*.82,T=d+Math.cos(c+Math.PI/2)*(w/(S.length-1)-.5)*A,D=m+Math.sin(c+Math.PI/2)*(w/(S.length-1)-.5)*A,I=T+Math.cos(v)*P,K=D+Math.sin(v)*P;return`<path class="thorn-spike" d="M ${T.toFixed(1)} ${D.toFixed(1)} L ${I.toFixed(1)} ${K.toFixed(1)}" />`}).join("")}
  `),Y(f,520)}function Zo(e){let t=C(e);t&&ge(t,"is-shaking",360)}function ta(e,t){let n=C(t);if(!n)return;let a=n.getBoundingClientRect(),o=a.left+a.width/2,r=a.top+a.height/2,s=Math.max(18,a.width*.18),c=q("heal-effect",e,"heal");c.innerHTML=re(`
  ...
  `}function Qt(e,t,n,a){let o=ut(t,a),r=rr(t,a),s=or[r]||"",c=t+1,l=n.side==="enemy"?"Enemy":"Your team",d=lr(n)?dr(o):"",m=!e&&cr(n,a),u=e?mr(e,n):d||sr(o,c,{collectionTeamTrigger:m});return`
  ...
  `}function nr(e=[],t="player"){let n=Array.from({length:9},()=>null),a=[],o=[];return(e||[]).slice(0,9).forEach((r,s)=>{let c=Qo(r),l=c!==null?ut(c,t):null,d={...r,position:l||br(r,s)};if(c!==null&&!n[c]&&ut(c,t)===d.position){n[c]=d;return}a.push({demon:d,preferredCell:Zt(s)})}),a.forEach(({demon:r,preferredCell:s})=>{if(!n[s]&&ut(s,t)===r.position){n[s]=r;return}o.push(r)}),o.forEach(r=>{let s=ar(n,t,r.position);s>=0&&(n[s]=r)}),n}function ar(e,t="player",n=null){for(let a of ir(t,n))if(!e[a])return a;return e.findIndex(a=>!a)}function ut(e,t="player"){let n=Zt(e)%3,a=t==="enemy"?0:2;return n===a?"front":"back"}var or={front:"frontline",mid:"middleline",back:"backline"};function rr(e,t="player"){let n=Zt(e)%3,a=t==="enemy"?0:2,o=t==="enemy"?2:0;return n===a?"front":n===o?"back":"mid"}function ir(e="player",t=null){let n=e==="enemy"?0:2,a=1,o=e==="enemy"?2:0;return(e==="enemy"?t==="front"?[n,a]:t==="back"?[o,a]:[n,a,o]:t==="front"?[n]:t==="back"?[a,o]:[n,a,o]).flatMap(s=>Array.from({length:3},(c,l)=>l*3+s))}function sr(e,t,n={}){return n.collectionTeamTrigger?`
  ...
  `}function cr(e,t){return!!(t==="player"&&e.side==="player"&&i.isRecruiting&&i.run?.awaitingRecruit&&i.run?.collectionReinforcementAvailable&&(i.recruitDraftTeam||[]).length<er()&&ga().length<ma())}function lr(e){return!!(i.isRecruiting&&e.side==="hand"&&i.run?.collectionReinforcementAvailable&&ga().length<ma())}function dr(e){return`
  ...
  `}function gr(e){let t=fa(e);return t?`
    <div class="demon-status-strip" aria-label="Status effects">
      <span class="demon-status-badge demon-status-poison" aria-label="Poisoned, ${t} stack${t===1?"":"s"}" title="Poisoned">
        <span class="demon-status-icon">${hr()}</span>
...
`),rarity:"account",icon:"sparkles",tags:["Permanent","Account"]}}function pa(e){let t=Number(e)||0;return Number.isInteger(t)?String(t):t.toFixed(1).replace(/\.0$/,"")}var td=window.AmongDemons.audio;var ba=!1;function yr(e){let t=String(e.rarity||"common").toLowerCase(),n=wr(e),a=Sr(n),o=e.href?"a":"button",r=e.href?`href="${k(e.href)}"`:'type="button"',s=e.attention?"is-level-power-attention":"",c=e.expiresAt?"is-temporary":"";return`
  ...
  `}function vr(e,t){let n=(Array.isArray(e?.effects)?e.effects:[]).filter(s=>String(s?.type||"").endsWith("_mult")).map(s=>Math.abs((Number(s.value)-1)*100)).filter(s=>Number.isFinite(s)&&s>0),a=String(e?.description||""),o=0,r=a.replace(/(\d+(?:\.\d+)?)%/g,(s,c)=>{let l=Number(c),d=n.findIndex(u=>Math.abs(u-l)<.001);if(d<0)return s;n.splice(d,1),o+=1;let m=l*t;return`${ya(m)}% (${t} x ${ya(l)}%)`});return o>0?r:`${a.replace(/\.$/,"")} (${t} copies).`}function ya(e){let t=Math.round((Number(e)||0)*100)/100;return Number.isInteger(t)?String(t):String(t).replace(/0+$/,"").replace(/\.$/,"")}function wr(e={}){let t=e.tooltip||`${e.name||e.id}: ${e.description||""}`,n=kr(e);return[t,n].filter(Boolean).join(`
`)}function kr(e={}){let t=Date.parse(e.expiresAt||"");if(!Number.isFinite(t))return"";let n=Math.ceil((t-Date.now())/1e3);return n<=0?"Expired":`Expires in ${$r(n)}`}function $r(e){let t=Math.max(0,Math.floor(Number(e)||0)),n=Math.floor(t/86400),a=Math.floor(t%86400/3600),o=Math.floor(t%3600/60);return n>0?`${n}d ${a}h`:a>0?`${a}h ${o}m`:o>0?`${o}m`:`${t}s`}function Sr(e){return k(e).replace(/\n/g,"&#10;")}function $a(){ba||(ba=!0,document.addEventListener("pointerover",e=>{let t=e.target.closest?.(".active-pact-chip");t&&mt(t)}),document.addEventListener("focusin",e=>{let t=e.target.closest?.(".active-pact-chip");t&&mt(t)}),document.addEventListener("click",e=>{let t=e.target.closest?.(".active-pact-chip");document.querySelectorAll(".active-pact-chip.is-tooltip-visible").forEach(n=>{n!==t&&n.classList.remove("is-tooltip-visible")}),t&&(mt(t),t.classList.add("is-tooltip-visible"))}),document.addEventListener("keydown",e=>{e.key==="Escape"&&document.querySelectorAll(".active-pact-chip.is-tooltip-visible").forEach(t=>{t.classList.remove("is-tooltip-visible")})}),window.addEventListener("resize",va),window.addEventListener("scroll",va,!0))}function va(){document.querySelectorAll(".active-pact-chip.is-tooltip-visible").forEach(mt)}function mt(e){if(!e)return;let t=e.getBoundingClientRect(),n=Math.min(384,window.innerWidth*.88),a=Pr(t.left+t.width/2,n/2+8,window.innerWidth-n/2-8),o=t.top>118,r=o?Math.max(8,t.top-8):Math.min(window.innerHeight-8,t.bottom+8);e.style.setProperty("--active-pact-tooltip-left",`${a}px`),e.style.setProperty("--active-pact-tooltip-top",`${r}px`),e.classList.toggle("is-tooltip-below",!o)}function Pr(e,t,n){return Math.max(t,Math.min(n,Number(e)||0))}var Rr=window.AmongDemons.audio,xr=window.AmongDemons.bagVisuals?.renderItemVisual||(()=>'<span class="bag-item-renderer bag-unknown-visual" aria-hidden="true"></span>');var Lr=(...e)=>h.bindCollectionReinforcementPlaceholders(...e),Cr=(...e)=>h.bindDemonDetailCards(...e),Br=(...e)=>h.bindFormationDragAndDrop(...e),Er=(...e)=>h.bindPointerDragAndDrop(...e),Ar=(...e)=>h.bindRecruitDragAndDrop(...e),Dr=(...e)=>h.bindRewardDragAndDrop(...e),on=(...e)=>h.canExtractRun(...e),Sa=(...e)=>h.formatBattleSpeed(...e),Tr=(...e)=>h.getRecruitPreviewEnemyTeam(...e),Mr=(...e)=>h.getRecruitPreviewHand(...e),Fr=(...e)=>h.getRecruitPreviewTeam(...e),Pa=(...e)=>h.applyDungeonCombatStatPreviewToDemon(...e),Ir=(...e)=>h.getRecruitTeamLimit(...e),Nr=(...e)=>h.groupCombatLog(...e),Ia=(...e)=>h.hasPendingBuffChoices(...e);var _r=(...e)=>h.isExtractionUnlocked(...e),Hr=(...e)=>h.isCurrentFloorBattle(...e),Or=(...e)=>h.pauseCombatPlayback(...e),zr=(...e)=>h.playEnemyRevealEffect(...e),Gr=(...e)=>h.playPendingHandFlowAnimation(...e),Vr=(...e)=>h.playRecruitSwapEffect(...e),Na=(...e)=>h.renderButtonMeleeIcon(...e);var Ra=(...e)=>h.renderDemonCards(...e),qr=(...e)=>h.renderDungeonDemonCard(...e),Yr=(...e)=>h.bindActivePactTooltips(...e),jr=(...e)=>h.getActiveBuffs(...e),Wr=(...e)=>h.createLevelPowerBuff(...e),tn=(...e)=>h.renderDemonicPacts(...e),Kr=(...e)=>h.toggleDemonicPactView(...e);var Ur=(...e)=>h.renderFightLogRow(...e),Xr=(...e)=>h.renderHandBar(...e),Zr=(...e)=>h.renderRewardBox(...e),rn=(...e)=>h.replayFight(...e),Jr=(...e)=>h.requestRecruitContinue(...e),Qr=(...e)=>h.resumeCombatPlayback(...e),ei=(...e)=>h.setBattleSpeed(...e),ti=(...e)=>h.skipCombatPlayback(...e),ni=(...e)=>h.startNewDungeonAfterDefeat(...e),_a=(...e)=>h.startRun(...e),ai=(...e)=>h.stepCombatPlayback(...e);function sn(){let e=i.run,t=!!e;if(b.runLoading&&b.runLoading.classList.toggle("d-none",!i.isLoading),b.runEmpty.classList.toggle("d-none",i.isLoading||t),b.runPanel.classList.toggle("d-none",i.isLoading||!t),hi(),gi(),i.isLoading){ue&&ue.disconnect(),i.isMobileRewardBoxOpen=!1,b.dungeonBottomPanel?.classList.remove("is-battle-active","is-mobile-reward-open"),b.fightLog.innerHTML="Opening the latest dungeon state...",b.fightLog.classList.add("text-muted"),tn(!1),We(),xe();return}if(!e){ue&&ue.disconnect(),b.runPanel?.querySelector(".dungeon-arena")?.classList.remove("is-hand-strategy"),b.dungeonBottomPanel?.classList.add("d-none"),i.isMobileRewardBoxOpen=!1,b.dungeonBottomPanel?.classList.remove("is-battle-active","is-mobile-reward-open"),b.dungeonHandBar?.classList.add("d-none"),b.dungeonRewardBox?.classList.add("d-none"),tn(!1),La(),Ca(),Ba(),b.runEmpty.innerHTML=i.endSummary?oi():ri(),ii(),xa(),We(),xe();return}let n=Ia(e),a=!!(i.isRecruiting&&e.awaitingRecruit),o=b.runPanel?.querySelector(".dungeon-arena"),r=(a?Fr():e.team||[]).map(Pa),s=a&&i.isEnemyPreviewDeferred?[]:a?Tr():e.enemies||[],c=!!e.replayOnly,l=!!(i.isBattleAnimating||c),d=!!(i.isPactTeamPreview&&n),m=!!(!a&&l),u=(a?Mr():[]).map(Pa),f=m?"battle":"recruit",S=!!(n&&!i.isPactRevealPending&&!i.isBattleAnimating&&!i.isResultAnimating),y=!!(n||i.isPactRevealPending),w=!0,v=!!(a&&!y),P=v,A=!!(!n&&!i.isResultAnimating&&on()),T=Ea(b.teamGrid),D=Ea(b.enemyGrid),I=["player",e.awaitingRecruit?"recruit":"battle",i.isRecruiting?"interactive":"locked",n?"pacts":"ready"].join(":");b.dungeonBottomPanel?.classList.toggle("d-none",!w),(!A||i.isBattleAnimating||i.isResultAnimating)&&(i.isMobileRewardBoxOpen=!1),b.dungeonBottomPanel?.classList.toggle("is-battle-active",l||d),b.dungeonBottomPanel?.classList.toggle("is-mobile-reward-open",!!(i.isMobileRewardBoxOpen&&A&&!i.isBattleAnimating)),o?.classList.toggle("is-hand-strategy",a),Q(b.teamGrid,Ra(r,{side:"player",allowFormationDrag:e.status==="active"&&!y&&(!e.awaitingRecruit||i.isRecruiting),gridStyle:T}),{patchFormationGrid:!0,renderKey:I}),Q(b.enemyGrid,Ra(a||(e.team||[]).length?s:[],{side:"enemy",allowRecruitDrag:!1,gridStyle:D}),{patchFormationGrid:!0,renderKey:"enemy"}),Xr(u,w,v,f),Zr(w,P,A),tn(S),La(a?r.length:null,a?Ir():null),Ca(a?e.nextEnemyPressure:e.enemyPressure,a?e.nextEnemyBuffs:e.enemyBuffs,a?e.nextEnemyTeamBuffs:e.enemyTeamBuffs),Ba(),Br(),Ar(),Dr(),Er(),Lr(),Cr(),Yr(),Vr(),zr(),fi(),xa(),We(),xe(),Gr(a)}function oi(){let e=i.endSummary||{},t=e.demon,n=e.echo,a=e.outcome==="defeat";return`
    <div class="dungeon-end-screen ${a?"is-defeat":"is-extraction"}">
      ...
      ${t?`
        <div class="dungeon-end-demon" aria-label="Collected demon">
          ${qr(t,{className:"dungeon-end-demon-card",suppressCollectionMissingTag:!0,attributes:{"data-instance-id":t.instanceId||`end-${t.id||"demon"}`}})}
        </div>
      `:""}
      ${n?`
        <div
          class="dungeon-end-demon dungeon-end-echo"
          style="--item-rarity: ${k(Pt(n.rarity||"common"))}"
          aria-label="Extracted ${k(`${at(n.rarity||"common")} ${n.species||"Demon"} Echo`)}"
        >
      ...
      <div class="dungeon-end-rewards" aria-label="Rewards obtained">
        ...
        ${n?`<span>${x("sparkles")}${k(`${at(n.rarity||"common")} ${n.species||"Demon"} Echo`)}</span>`:""}
  ...
  `}function ii(){N(document.getElementById("startNewDungeonBtn"),async()=>{Tn(),await _a(),sn()}),N(document.getElementById("replayEndedDungeonBtn"),rn)}function xa(){let t=(i.combatLog.length?Nr(i.combatLog).map((n,a)=>`
      ${Ur(n,a)}
    `).join(""):"")+bi();if(!t.trim()){b.fightLog.innerHTML="Fight log will appear here after a battle.",b.fightLog.classList.add("text-muted");return}b.fightLog.classList.remove("text-muted"),b.fightLog.innerHTML=t}function Ha(e,t={}){let n=document.querySelector(".battle-result-burst");n&&n.remove();let a=e==="defeat",o=t.syncActions!==!1,s=!!window.matchMedia?.("(prefers-reduced-motion: reduce)").matches?900:a?3e3:2200;i.isResultAnimating=!0,Rr?.play(e==="victory"?"sfx.battle.victory":"sfx.battle.defeat",{volume:.96}),o&&(We(),xe());let c=document.createElement("div");return c.className=`battle-result-burst is-${e}`,c.style.setProperty("--battle-result-duration",`${s}ms`),c.setAttribute("role","status"),c.setAttribute("aria-live","polite"),c.innerHTML=`
  ...
  `,document.body.appendChild(c),new Promise(l=>{setTimeout(()=>{c.remove(),i.isResultAnimating=!1,o&&(We(),xe()),l()},s)})}function La(e=null,t=null){if(!b.teamSideTitle)return;let n=Number.isFinite(e)&&Number.isFinite(t)?`<span class="battle-side-count" aria-label="${e} of ${t} team slots used">${e}/${t}</span>`:"",a=si();b.teamSideTitle.innerHTML=`
    <span>Your Team</span>
    ${n?` ${n}`:""}
    ${Ke(a,{side:"player"})}
  `}function Ca(e=null,t=[],n=[]){if(!b.enemySideTitle)return;let a=i.run?.enemyLabel||"Enemies";b.enemySideTitle.innerHTML=`
    ...
    ${ui(t)}
    ${Ke(n,{side:"enemy"})}
  `}function si(e=i.run){if(!e)return[];let t=i.statPoints?Wr(i.statPoints):null;return[...t?[t]:[],...jr(e)].filter(n=>n?.id||n?.name)}function Ke(e=[],t={}){let n=ci(e);if(!n.length)return"";let a=n.reduce((c,l)=>c+l.stackCount,0),o=t.side==="enemy"?"enemy":"player",r=t.label||"Buffs",s=`battle-${o}-buff-summary-tooltip`;return`
    <span
  ...
  `}function ci(e=[]){let t=[],n=new Map;return(Array.isArray(e)?e:[]).forEach((a,o)=>{if(!a)return;let r=typeof a=="string"?{id:a,name:a,description:""}:a,s=String(r.id||r.name||`buff-${o+1}`),c=Math.max(1,Math.trunc(Number(r.stackCount)||1)),l=n.get(s);if(l){l.stackCount+=c;return}let d={...r,id:s,stackCount:c};n.set(s,d),t.push(d)}),t}function li(e={}){let t=String(e.name||e.id||"Buff"),n=e.stackCount>1?` \xD7${e.stackCount}`:"",a=String(e.description||e.tooltip||"").trim(),o=a.startsWith(`${t}
`)?a.slice(t.length+1).trim():a;return`
  ...
  `}function di(e=null){if(!e?.active)return"";let t=Ae(e.hpBonusPct),n=Ae(e.atkBonusPct),a=Ae(e.speedBonusPct),o=Math.max(0,Math.round(Number(e.level)||0));if(o<=0)return"";let r=[`Terror ${o}`,e.description||"Demons grow stronger in darkness.",`Enemy HP ${t}`,`Enemy Attack ${n}`,`Enemy Speed ${a}`].join(`
`),s=Oa(r);return`
    <span
  ...
  `}function ui(e=[]){let t=(Array.isArray(e)?e:[]).filter(Boolean);return t.length?t.map(mi).join(""):""}function mi(e={}){let t=String(e.name||e.id||"Boss Buff"),n=String(e.description||""),a=e.id==="rarity-convergence",o=a?[t,n,`Host HP ${Ae(e.hpBonusPct)}`,`Host Attack ${Ae(e.atkBonusPct)}`,`Host Speed ${Ae(e.speedBonusPct)}`].join(`
`):[t,n].filter(Boolean).join(`
`),r=Oa(o),s=a?` style="--enemy-buff-color: ${k(Pt(e.rarity||"common"))}"`:"";return`
    <span
  ...
  `}function Da(e,t){return b.dungeonReplayLogBox?Q(b.dungeonReplayLogBox,cn(e,t)):!1}function We(){if(i.isLoading){Ta(),Ma({canReplay:!1,canViewLog:!1,canExtract:!1}),Aa(""),Da(!1,!1);return}let e=i.run?.status==="defeated",t=!i.endSummary&&(!i.run||e||i.run.status==="ended"),n=!!(i.run&&!i.isResultAnimating&&i.isBattleAnimating&&i.combatPlayback),a=Ia(i.run),o=!!(i.isPactTeamPreview&&a),r=!!(Hr(i.run)&&(i.run?.lastBattle?.combatLog?.length||i.combatLog.length)),s=!!(!i.isBattleAnimating&&!i.isResultAnimating&&!a&&r),c=s,l=!!(!a&&!i.isResultAnimating&&i.run?.awaitingRecruit&&i.isRecruiting),d=!!(!i.isBattleAnimating&&!i.isResultAnimating&&!a&&on()),m=!!i.isRecruitContinuePending,u=!!i.isBattleAnimating,f={canFight:l||m||u,isPending:m,isFighting:u,canStart:t&&!!i.run,isDefeated:e,canReplay:s,canViewLog:c,canExtract:d};Ta(f);let S=Ma(f),y=o?un():n?`${ln()}${dn()}${mn()}`:"",w=Aa(y),v=Da(s,c);!w&&!v&&!S||(nt("[data-battle-speed]",P=>ei(Number(P.dataset.battleSpeed))),N(document.getElementById("battlePlaybackToggleBtn"),()=>{i.combatPlayback?.isPaused?Qr():Or()}),nt("[data-battle-step]",P=>ai(Number(P.dataset.battleStep))),N(document.getElementById("battlePlaybackSkipBtn"),ti),N(document.getElementById("demonicPactReturnBtn"),Kr),N(document.getElementById("fightLogReplayBtn"),rn),N(document.getElementById("fightLogToggleBtn"),gt))}function Ta(e={}){let{canFight:t=!1,isPending:n=!1,isFighting:a=!1,canStart:o=!1,isDefeated:r=!1}=e;if(o){Q(b.dungeonCenterActions,`
    ...
    `)&&N(document.getElementById("dungeonCenterStartBtn"),r?ni:_a);return}let s=a?"fighting":n?"preparing":"ready",c=s!=="ready",l=s==="fighting"?"Fighting":s==="preparing"?"Preparing":"Fight",d=s==="fighting"?"Fight in progress":s==="preparing"?"Preparing the next fight":"Start the next fight";Q(b.dungeonCenterActions,t?`
    <div class="dungeon-center-action-stack">
  ...
  `:"")&&za()}function Ma(e={}){if(!b.dungeonMobileFightBox)return!1;if(i.isLoading)return Q(b.dungeonMobileFightBox,"");let{canFight:t=!1,isPending:n=!1,isFighting:a=!1,canReplay:o=!1,canViewLog:r=!1,canExtract:s=!1}=e,c=a?"fighting":n?"preparing":"ready",l=c!=="ready",d=c==="fighting"?"Fighting":c==="preparing"?"Preparing":"Fight",m=c==="fighting"?"Fight in progress":c==="preparing"?"Preparing the next fight":"Start the next fight",u=!!i.run,f=i.activeHandTab==="pacts"?"pacts":"hand",S=!!(i.isMobileRewardBoxOpen&&s),y=!u||a,w=_r(i.run)?"Extract":"Win your first fight to unlock extraction",v=Q(b.dungeonMobileFightBox,`
    <button
  ...
  `);return v&&(yi(),za()),v}function yi(){N(document.getElementById("dungeonMobileHandBtn"),()=>Fa("hand")),N(document.getElementById("dungeonMobileBuffsBtn"),()=>Fa("pacts")),N(document.getElementById("dungeonMobileReplayBtn"),rn),N(document.getElementById("dungeonMobileLogBtn"),gt),N(document.getElementById("dungeonMobileExtractBtn"),vi)}function Fa(e){!i.run||i.isBattleAnimating||(i.activeHandTab=e==="pacts"?"pacts":"hand",sn())}function vi(){i.isBattleAnimating||i.isResultAnimating||!on()||(i.isMobileRewardBoxOpen=!i.isMobileRewardBoxOpen,sn())}function ln(){let e=i.combatPlayback||{},t=!!e.isPaused,n=Number(e.currentIndex)||0,a=Number(e.totalSteps)||0,o=n>0,r=n<a;return`
  ...
  `}function za(){[document.getElementById("dungeonFightBtn"),document.getElementById("dungeonMobileFightBtn")].forEach(e=>{!e||e.dataset.dungeonFightBound==="true"||(e.dataset.dungeonFightBound="true",N(e,t=>Jr(t.currentTarget)))})}var wt=window.AmongDemons.api,$e=window.AmongDemons.audio,wi=window.AmongDemons.ui.renderDemonCard,M=window.AmongDemons.ui.renderIcon||(()=>""),Ue=Object.freeze(["common","uncommon","rare","epic","legendary","mythic"]),Xe=2,et=20,Ga=Object.freeze({common:1,uncommon:2,rare:3,epic:4,legendary:5,mythic:7}),g={},Va=new Set,W=!1,R=null,p=null,se=!1,$=null,yn=0,J=0,De=null,ft=null,qa=0,vn=new Set,Ya=null,Ze=0;Cn({...Xt,battle:to,getExplicitFormationRow:e=>ce(e?.formationSlot),normalizeFormationRow:e=>ce(e)??0,shouldShowCollectionMissingTag:()=>!1,getDemonPosition:is,renderDemonStatus:ss,renderDungeonCenterActions:ho,renderFightLog:io,renderFightLogActions:so,renderRun:O});us(ki);async function ki(){if(!window.AmongDemons.getToken()){window.location.href=window.AmongDemons.appUrl("/login?next=/ranked");return}$i(),Si(),$a(),lt(),$e?.setScene({music:"music.default"}),await Pi()}function $i(){["rankedMessage","runLoading","runEmpty","runPanel","rankedBottomPanel","rankedHandStatus","rankedPreparation","dungeonHandBar","dungeonBottomControls","dungeonReplayLogBox","teamSideTitle","enemySideTitle","teamGrid","enemyGrid","dungeonCenterActions","fightLog","demonicPactOverlay","demonicPactViewToggle","rankedPactGrid","rankedVictoryModal","rankedVictoryRankImage","rankedVictoryDivision","rankedVictoryRankGain","rankedVictorySummary"].forEach(e=>{g[e]=document.getElementById(e)})}function Si(){document.addEventListener("click",async e=>{let t=e.target.closest("[data-ranked-victory-action]");if(t){e.preventDefault(),await qi(t.dataset.rankedVictoryAction);return}let n=e.target.closest("[data-battle-speed]");if(n){e.preventDefault(),jt(Number(n.dataset.battleSpeed));return}let a=e.target.closest("[data-battle-step]");if(a){e.preventDefault(),Ht(Number(a.dataset.battleStep));return}if(e.target.closest("#battlePlaybackToggleBtn")){e.preventDefault(),i.combatPlayback?.isPaused?_t():Nt();return}if(e.target.closest("#battlePlaybackSkipBtn")){e.preventDefault(),Ot();return}if(e.target.closest("#fightLogReplayBtn, #rankedMobileReplayBtn")){e.preventDefault(),await Ei();return}if(e.target.closest("#fightLogToggleBtn, #rankedMobileLogBtn")){e.preventDefault(),gt();return}if(e.target.closest("#demonicPactViewToggle, #demonicPactReturnBtn")){e.preventDefault(),Hi();return}let o=e.target.closest("[data-ranked-action]");if(o?.matches("button")){e.preventDefault(),await ja(o,e);return}o&&(e.preventDefault(),await ja(o,e))}),document.addEventListener("dragstart",e=>{let t=e.target.closest("[data-ranked-workspace-id]");if(!t||!e.dataTransfer||!p)return;let n=t.dataset.rankedWorkspaceId;e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",n),t.classList.add("is-dragging")}),document.addEventListener("dragend",e=>{e.target.closest("[data-ranked-workspace-id]")?.classList.remove("is-dragging"),yn=Date.now()+350,Z()}),document.addEventListener("dragover",e=>{let t=vt(e.target);t&&(e.preventDefault(),Z(),t.classList.add("is-drag-over"))}),document.addEventListener("dragleave",e=>{let t=vt(e.target);t&&!t.contains(e.relatedTarget)&&t.classList.remove("is-drag-over")}),document.addEventListener("drop",e=>{let t=vt(e.target);if(!t)return;e.preventDefault();let n=e.dataTransfer?.getData("text/plain");n&&fo(n,t,{x:e.clientX,y:e.clientY})}),document.addEventListener("pointerdown",ts),document.addEventListener("pointermove",ns),document.addEventListener("pointerup",os),document.addEventListener("pointercancel",rs),document.addEventListener("keydown",e=>{let t=e.target.closest(".dungeon-demon-card[data-instance-id]");!t||!["Enter"," "].includes(e.key)||(e.preventDefault(),co(t))})}async function Pi(){pn(!0);try{let[e]=await Promise.all([wt("/api/ranked/bootstrap"),Ri().catch(t=>(console.warn("Ranked upgrade previews will use current-card art.",t),null))]);e.player&&Pn(e.player),e.run?(Me(e.run),e.run.status==="active"&&e.run.phase==="result"&&!e.run.awaitingVictoryChoice&&await eo()):(i.run=null,R=null),pn(!1),O(),R?.awaitingVictoryChoice&&lo(R)}catch(e){pn(!1),kt(e)}}async function Ri(){return De||(ft||(ft=wt("/api/game/catalog?v=20260722-request-optimization-v1").then(e=>(De={types:e?.types||{},demons:Array.isArray(e?.demons)?e.demons:[]},De)).catch(e=>{throw ft=null,e})),ft)}async function xi(){let e=await ao("/api/ranked/start",{});e?.run&&Me(e.run)}async function ja(e,t=null){if(W)return;let n=e.dataset.rankedAction;if(n==="start")return xi();if(R){if(n==="reroll")return Ci(Rn(t,e));if(n==="lock-hand")return Bi();if(n==="fight")return to();if(n==="continue")return eo();if(n==="end")return window.confirm("End this Ranked run and finalize its current Rank Points?")?Te("end",{}):void 0;if(n==="pact")return Li(e.dataset.buffId)}}async function Te(e,t){let n=await ao(`/api/ranked/runs/${encodeURIComponent(R.runId)}/${e}`,t);return n?.player&&Pn(n.player,{animate:!0}),n?.run&&(Me(n.run),n.rewards?.souls&&Ie(`Floor ${et} cleared. ${n.rewards.souls} Souls awarded.`,"success")),n}async function eo(){let e=await Te("continue",{});e?.run?.phase==="selection"&&e.run.floor>et&&Ie("Endless floor unlocked.","success")}async function Li(e){let t=await Te("pact",{buffId:e});if(t?.run&&($e?.play("sfx.dungeon.pactChoose",{volume:.9}),!t.run.pendingPact&&Ze>0)){let n=Ze;Ze=0,window.requestAnimationFrame(()=>cs(n))}return t}async function Ci(e){if(!go()||W)return;let t=await Te("reroll",{lineup:uo(),lockHand:!!R.handLocked});if(!t?.run)return;let n=Math.max(0,Number(t.rerollCost)||Xe);xn(e,-n),$e?.play("sfx.dungeon.pactReroll",{volume:.86})}async function to(){if(!(!mo()||W||i.isBattleAnimating)){Ze=0,Fe(!0),se=!0;try{let e=await wt(`/api/ranked/runs/${encodeURIComponent(R.runId)}/battle`,oo({lineup:uo(),lockHand:!!R.handLocked}));if(!e?.run?.lastBattle)return;let t=e.rSoulInterest;Me(e.run,{render:!1}),Number(t?.earned)>0&&(J=Math.max(0,Number(t.balanceBefore)||0));let n=e.run.lastBattle;no(n),fe("combat"),O(),await rt(),await Vi(n.winner),Me(e.run,{render:!1});let a=[];e.rewards?.souls&&(a.push(`Victory milestone: ${e.rewards.souls} Souls awarded.`),e.player&&Pn(e.player,{animate:!0})),Number(t?.earned)>0&&(Ze=Math.max(0,Number(t.earned)||0)),Ie(a.length?a.join(" "):"","success"),e.run.awaitingVictoryChoice&&lo(e.run,{rankGain:e.rankGain})}catch(e){kt(e)}finally{se=!1,Fe(!1),O()}}}function Bi(){if(!R||!kn(R))return;let e=!R.handLocked;R.handLocked=e,i.run.handLocked=e,O()}async function Ei(){let e=R?.lastBattle;if(!(W||i.isBattleAnimating||!e?.combatLog?.length)){se=!0,Fe(!0);try{no(e),fe("combat"),O(),g.fightLog.innerHTML="",g.fightLog.classList.remove("text-muted"),await rt(),Me(R,{render:!1})}catch(t){kt(t)}finally{se=!1,Fe(!1),O()}}}function no(e){i.run.team=j(e.playerTeamBefore||i.run.team||[]),i.run.active=i.run.team,i.run.enemies=j(e.enemyTeamBefore||i.run.enemies||[]),i.combatLog=e.combatLog||[],i.combatDemons=Ye()}async function ao(e,t){Fe(!0);try{return await wt(e,oo(t))}catch(n){return kt(n),null}finally{Fe(!1)}}function oo(e){let t=ls();return{method:"POST",headers:{"Idempotency-Key":t},body:{...e,actionId:t}}}function Me(e,t={}){R=e,J=Math.max(0,Number(e.rSouls)||0);let n=e.lastBattle;p=kn(e)?ji(e):null,i.run={...e,team:j(p?.active||e.active||e.team),active:j(p?.active||e.active||e.team),reserve:j(p?.reserve||e.reserve),enemies:e.phase==="result"&&n?j(n.enemyTeamAfter):j(e.enemies)},i.combatLog=n?.combatLog||[],i.combatDemons=Ye(),t.render!==!1&&O(),zi(e.combinationEvents||[])}function O(){Wi();let e=i.run,t=!!e;if(g.runEmpty.classList.toggle("d-none",t||i.isLoading),g.runPanel.classList.toggle("d-none",!t||i.isLoading),g.rankedBottomPanel.classList.toggle("d-none",!t||i.isLoading),!t){fe("combat"),g.runEmpty.innerHTML=`
      <div class="ranked-end-card">
        ...
        <button class="btn btn-primary btn-lg" type="button" data-ranked-action="start" ${W?"disabled":""}>
          ${M("trophy")} Start Ranked Run
        </button>
      </div>
    `;return}if((e.status==="ended"||e.phase==="ended")&&!se){fe("combat"),g.runPanel.classList.add("d-none"),g.rankedBottomPanel.classList.add("d-none"),g.runEmpty.classList.remove("d-none"),g.runEmpty.innerHTML=Oi(e),Ka([]);return}let n=se||i.isBattleAnimating,a=n,o=!!(i.isPactTeamPreview&&e.pendingPact&&!a),r=a||o,s=!!(!r&&(e.lastBattle?.combatLog?.length||i.combatLog?.length));g.enemyGrid.closest(".battle-side")?.classList.toggle("is-ranked-reserve",!a),g.rankedBottomPanel.classList.toggle("is-ranked-combat",r),g.rankedBottomPanel.classList.remove("has-fight-review"),g.rankedBottomPanel.classList.toggle("is-battle-active",n),g.dungeonHandBar.classList.toggle("d-none",!r),g.dungeonHandBar.classList.toggle("is-battle-controls-mode",r),g.dungeonReplayLogBox.classList.add("d-none"),a||fe("combat"),Ai(e),Ti(e,a),ho(),g.teamGrid.innerHTML=Jt(e.team||e.active||[],{side:"player",allowFormationDrag:!a&&!e.pendingPact}),g.enemyGrid.innerHTML=a?Jt(e.enemies||[],{side:"enemy"}):Fi(e.reserve||[],e),g.rankedPreparation.classList.toggle("d-none",a||o||e.phase==="preparation"&&i.isBattleAnimating);let c=!g.rankedPreparation.classList.contains("d-none"),l=Math.max(0,Math.min(3,Number(e.lives)||0)),d=Array.from({length:3},(m,u)=>`
    ...
    `).join("");g.rankedHandStatus.classList.toggle("d-none",!c),g.rankedHandStatus.setAttribute("aria-label",`${l} of 3 lives, ${E(J)} Ranked Souls`),g.rankedHandStatus.innerHTML=c?`
      ...
      ${Di(e)}
    `:"",g.rankedPreparation.innerHTML=a||o?"":Ni(e,{canReviewFight:s}),so(),io(),Ka(e.pacts?.pendingChoices||[]),Gi(),Ki(),Ui()}function Ai(e){let t=e.rating?.division||"Bronze II",n=wn(t),a=Array.isArray(e.team)?e.team:e.active||[],o=Math.max(1,Number(e.capacities?.active)||6),r=Math.min(o,a.length);g.teamSideTitle.innerHTML=`
  ...
  `}function ro(e){let t=e.lockedBonuses||{},n=Object.values(t.allocations||{}).reduce((s,c)=>s+Math.max(0,Number(c)||0),0),a=ha({spentPoints:n,bonuses:t.skillBonuses||{}}),o=wa(Array.isArray(e.pacts?.activeBuffs)?e.pacts.activeBuffs:[]),r=(Array.isArray(t.activeBuffs)?t.activeBuffs:[]).filter(s=>s?.source!=="skill_tree");return[...a?[a]:[],...o,...r].filter(s=>s?.id)}function Mi(e){return ka(e,{stackClass:"ranked-pact-stack",countClass:"ranked-pact-stack-count"})}function Fi(e,t){let n=Array.from({length:t.capacities.reserve},()=>null),a=[];e.forEach(r=>{let s=pe(r.reserveSlot);s!==null&&!n[s]?n[s]=r:a.push(r)}),a.forEach(r=>{let s=n.findIndex(c=>!c);s>=0&&(n[s]=r)});let o=ro(t);return`
